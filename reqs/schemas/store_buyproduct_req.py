...
class StoreBuyproductReq:
    ...
    _validations_map = {
        'ageCheck': { 'required': False,},
        'appExtVrsId': { 'required': True,},
        'guid': { 'required': True,},
        'hasBeenAuthedForBuy': { 'required': False,},
        'isInApp': { 'required': False,},
        'kbsync': { 'required': True,},
        'sbsync': { 'required': False,},
        'afds': { 'required': False,},
        'machineName': { 'required': False,},
        'mtApp': { 'required': False,},
        'mtClientId': { 'required': False,},
        'mtEventTime': { 'required': False,},
        'mtPageId': { 'required': False,},
        'mtPageType': { 'required': False,},
        'mtPrevPage': { 'required': False,},
        'mtRequestId': { 'required': False,},
        'mtTopic': { 'required': False,},
        'needDiv': { 'required': False,},
        'pg': { 'required': False,},
        'price': { 'required': True,},
        'pricingParameters': { 'required': True,},
        'productType': { 'required': True,},
        'salableAdamId': { 'required': True,},
        'hasAskedToFulfillPreorder': { 'required': False,},
        'buyWithoutAuthorization': { 'required': False,},
        'hasDoneAgeCheck': { 'required': False,},
        'hasConfirmedPaymentSheet': { 'required': False,},
        'asn': { 'required': False,},
    }

    def __init__(self
            , ageCheck: str=None            , appExtVrsId: str=None            , guid: str=None            , hasBeenAuthedForBuy: str=None            , isInApp: str=None            , kbsync: str=None            , sbsync: str=None            , afds: str=None            , machineName: str=None            , mtApp: str=None            , mtClientId: str=None            , mtEventTime: str=None            , mtPageId: str=None            , mtPageType: str=None            , mtPrevPage: str=None            , mtRequestId: str=None            , mtTopic: str=None            , needDiv: str=None            , pg: str=None            , price: str=None            , pricingParameters: str=None            , productType: str=None            , salableAdamId: str=None            , hasAskedToFulfillPreorder: str=None            , buyWithoutAuthorization: str=None            , hasDoneAgeCheck: str=None            , hasConfirmedPaymentSheet: str=None            , asn: str=None            ):
        pass
    ...
    hasAskedToFulfillPreorder = property(_get_hasAskedToFulfillPreorder, _set_hasAskedToFulfillPreorder)
    ...
    buyWithoutAuthorization = property(_get_buyWithoutAuthorization, _set_buyWithoutAuthorization)
    ...
    def from_dict(d):
        v = {}
        if "ageCheck" in d:
            v["ageCheck"] = str.from_dict(d["ageCheck"]) if hasattr(str, 'from_dict') else d["ageCheck"]
        if "appExtVrsId" in d:
            v["appExtVrsId"] = str.from_dict(d["appExtVrsId"]) if hasattr(str, 'from_dict') else d["appExtVrsId"]
        if "guid" in d:
            v["guid"] = str.from_dict(d["guid"]) if hasattr(str, 'from_dict') else d["guid"]
        if "hasBeenAuthedForBuy" in d:
            v["hasBeenAuthedForBuy"] = str.from_dict(d["hasBeenAuthedForBuy"]) if hasattr(str, 'from_dict') else d["hasBeenAuthedForBuy"]
        if "isInApp" in d:
            v["isInApp"] = str.from_dict(d["isInApp"]) if hasattr(str, 'from_dict') else d["isInApp"]
        if "kbsync" in d:
            v["kbsync"] = str.from_dict(d["kbsync"]) if hasattr(str, 'from_dict') else d["kbsync"]
        if "sbsync" in d:
            v["sbsync"] = str.from_dict(d["sbsync"]) if hasattr(str, 'from_dict') else d["sbsync"]
        if "afds" in d:
            v["afds"] = str.from_dict(d["afds"]) if hasattr(str, 'from_dict') else d["afds"]
        if "machineName" in d:
            v["machineName"] = str.from_dict(d["machineName"]) if hasattr(str, 'from_dict') else d["machineName"]
        if "mtApp" in d:
        ...
        if "needDiv" in d:
            v["needDiv"] = str.from_dict(d["needDiv"]) if hasattr(str, 'from_dict') else d["needDiv"]
        if "pg" in d:
        ...
        if "pricingParameters" in d:
            v["pricingParameters"] = str.from_dict(d["pricingParameters"]) if hasattr(str, 'from_dict') else d["pricingParameters"]
        if "productType" in d:
            v["productType"] = str.from_dict(d["productType"]) if hasattr(str, 'from_dict') else d["productType"]
        ...
        if "hasAskedToFulfillPreorder" in d:
            v["hasAskedToFulfillPreorder"] = str.from_dict(d["hasAskedToFulfillPreorder"]) if hasattr(str, 'from_dict') else d["hasAskedToFulfillPreorder"]
        if "buyWithoutAuthorization" in d:
            v["buyWithoutAuthorization"] = str.from_dict(d["buyWithoutAuthorization"]) if hasattr(str, 'from_dict') else d["buyWithoutAuthorization"]
        if "hasDoneAgeCheck" in d:
            v["hasDoneAgeCheck"] = str.from_dict(d["hasDoneAgeCheck"]) if hasattr(str, 'from_dict') else d["hasDoneAgeCheck"]
        if "hasConfirmedPaymentSheet" in d:
            v["hasConfirmedPaymentSheet"] = str.from_dict(d["hasConfirmedPaymentSheet"]) if hasattr(str, 'from_dict') else d["hasConfirmedPaymentSheet"]
        if "asn" in d:
            v["asn"] = str.from_dict(d["asn"]) if hasattr(str, 'from_dict') else d["asn"]
    ...
    def as_dict(self):
        ...
        if self.__ageCheck is not None:
            d['ageCheck'] = self.__ageCheck.as_dict() if hasattr(self.__ageCheck, 'as_dict') else self.__ageCheck
        if self.__appExtVrsId is not None:
            d['appExtVrsId'] = self.__appExtVrsId.as_dict() if hasattr(self.__appExtVrsId, 'as_dict') else self.__appExtVrsId
        ...
        if self.__hasBeenAuthedForBuy is not None:
            d['hasBeenAuthedForBuy'] = self.__hasBeenAuthedForBuy.as_dict() if hasattr(self.__hasBeenAuthedForBuy, 'as_dict') else self.__hasBeenAuthedForBuy
        if self.__isInApp is not None:
            d['isInApp'] = self.__isInApp.as_dict() if hasattr(self.__isInApp, 'as_dict') else self.__isInApp
        if self.__kbsync is not None:
            d['kbsync'] = self.__kbsync.as_dict() if hasattr(self.__kbsync, 'as_dict') else self.__kbsync
        if self.__sbsync is not None:
            d['sbsync'] = self.__sbsync.as_dict() if hasattr(self.__sbsync, 'as_dict') else self.__sbsync
        if self.__afds is not None:
            d['afds'] = self.__afds.as_dict() if hasattr(self.__afds, 'as_dict') else self.__afds
        if self.__machineName is not None:
            d['machineName'] = self.__machineName.as_dict() if hasattr(self.__machineName, 'as_dict') else self.__machineName
        ...
        if self.__needDiv is not None:
            d['needDiv'] = self.__needDiv.as_dict() if hasattr(self.__needDiv, 'as_dict') else self.__needDiv
        if self.__pg is not None:
            d['pg'] = self.__pg.as_dict() if hasattr(self.__pg, 'as_dict') else self.__pg
        ...
        if self.__pricingParameters is not None:
            d['pricingParameters'] = self.__pricingParameters.as_dict() if hasattr(self.__pricingParameters, 'as_dict') else self.__pricingParameters
        if self.__productType is not None:
            d['productType'] = self.__productType.as_dict() if hasattr(self.__productType, 'as_dict') else self.__productType
