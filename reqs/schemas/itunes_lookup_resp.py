...
class ItunesLookupResp:
    class _results:
            ...
            _validations_map = {
                'appletvScreenshotUrls': { 'required': True,},
                'screenshotUrls': { 'required': True,},
                'ipadScreenshotUrls': { 'required': True,},
                'artworkUrl60': { 'required': True,},
                'artworkUrl512': { 'required': True,},
                'artworkUrl100': { 'required': True,},
                'artistViewUrl': { 'required': True,},
                'supportedDevices': { 'required': True,},
                'advisories': { 'required': True,},
                'isGameCenterEnabled': { 'required': True,},
                'kind': { 'required': True,},
                'features': { 'required': True,},
                'minimumOsVersion': { 'required': True,},
                'trackCensoredName': { 'required': True,},
                'languageCodesISO2A': { 'required': True,},
                'fileSizeBytes': { 'required': True,},
                'formattedPrice': { 'required': True,},
                'contentAdvisoryRating': { 'required': True,},
                'averageUserRatingForCurrentVersion': { 'required': True,},
                'userRatingCountForCurrentVersion': { 'required': True,},
                'averageUserRating': { 'required': True,},
                'trackViewUrl': { 'required': True,},
                'trackContentRating': { 'required': True,},
                'releaseDate': { 'required': True,},
                'genreIds': { 'required': True,},
                'primaryGenreName': { 'required': True,},
                'trackId': { 'required': True,},
                'trackName': { 'required': True,},
                'sellerName': { 'required': True,},
                'isVppDeviceBasedLicensingEnabled': { 'required': True,},
                'currentVersionReleaseDate': { 'required': True,},
                'releaseNotes': { 'required': True,},
                'primaryGenreId': { 'required': True,},
                'currency': { 'required': True,},
                'version': { 'required': True,},
                'wrapperType': { 'required': True,},
                ...
                'userRatingCount': { 'required': True,},
            }

            def __init__(self
                    , appletvScreenshotUrls: List[float]
        =None            , screenshotUrls: List[str]
        =None            , ipadScreenshotUrls: List[str]
        =None            , artworkUrl60: str=None            , artworkUrl512: str=None            , artworkUrl100: str=None            , artistViewUrl: str=None            , supportedDevices: List[str]
        =None            , advisories: List[float]
        =None            , isGameCenterEnabled: bool=None            , kind: str=None            , features: List[str]
        =None            , minimumOsVersion: str=None            , trackCensoredName: str=None            , languageCodesISO2A: List[str]
        =None            , fileSizeBytes: str=None            , formattedPrice: str=None            , contentAdvisoryRating: str=None            , averageUserRatingForCurrentVersion: float=None            , userRatingCountForCurrentVersion: int=None            , averageUserRating: float=None            , trackViewUrl: str=None            , trackContentRating: str=None            , releaseDate: str=None            , genreIds: List[str]
        =None            , primaryGenreName: str=None            , trackId: int=None            , trackName: str=None            , sellerName: str=None            , isVppDeviceBasedLicensingEnabled: bool=None            , currentVersionReleaseDate: str=None            , releaseNotes: str=None            , primaryGenreId: int=None            , currency: str=None            , version: str=None            , wrapperType: str=None            , artistId: int=None            , artistName: str=None            , genres: List[str]
        =None            , price: float=None            , description: str=None            , bundleId: str=None            , userRatingCount: int=None            ):
                pass
                ...
                self.__averageUserRatingForCurrentVersion = averageUserRatingForCurrentVersion
            ...
            appletvScreenshotUrls = property(_get_appletvScreenshotUrls, _set_appletvScreenshotUrls)
            ...
            isGameCenterEnabled = property(_get_isGameCenterEnabled, _set_isGameCenterEnabled)
            ...
            contentAdvisoryRating = property(_get_contentAdvisoryRating, _set_contentAdvisoryRating)
            ...
            averageUserRatingForCurrentVersion = property(_get_averageUserRatingForCurrentVersion, _set_averageUserRatingForCurrentVersion)
            ...
            userRatingCountForCurrentVersion = property(_get_userRatingCountForCurrentVersion, _set_userRatingCountForCurrentVersion)
            ...
            isVppDeviceBasedLicensingEnabled = property(_get_isVppDeviceBasedLicensingEnabled, _set_isVppDeviceBasedLicensingEnabled)
            ...
            currentVersionReleaseDate = property(_get_currentVersionReleaseDate, _set_currentVersionReleaseDate)
            ...
            def from_dict(d):
                ...
                if "appletvScreenshotUrls" in d:
                    v["appletvScreenshotUrls"] = [float.from_dict(p) if hasattr(float, 'from_dict') else p for p in d["appletvScreenshotUrls"]]
                if "screenshotUrls" in d:
                    v["screenshotUrls"] = [str.from_dict(p) if hasattr(str, 'from_dict') else p for p in d["screenshotUrls"]]
                if "ipadScreenshotUrls" in d:
                    v["ipadScreenshotUrls"] = [str.from_dict(p) if hasattr(str, 'from_dict') else p for p in d["ipadScreenshotUrls"]]
                if "artworkUrl60" in d:
                    v["artworkUrl60"] = str.from_dict(d["artworkUrl60"]) if hasattr(str, 'from_dict') else d["artworkUrl60"]
                if "artworkUrl512" in d:
                    v["artworkUrl512"] = str.from_dict(d["artworkUrl512"]) if hasattr(str, 'from_dict') else d["artworkUrl512"]
                if "artworkUrl100" in d:
                    v["artworkUrl100"] = str.from_dict(d["artworkUrl100"]) if hasattr(str, 'from_dict') else d["artworkUrl100"]
                if "artistViewUrl" in d:
                    v["artistViewUrl"] = str.from_dict(d["artistViewUrl"]) if hasattr(str, 'from_dict') else d["artistViewUrl"]
                if "supportedDevices" in d:
                    v["supportedDevices"] = [str.from_dict(p) if hasattr(str, 'from_dict') else p for p in d["supportedDevices"]]
                if "advisories" in d:
                    v["advisories"] = [float.from_dict(p) if hasattr(float, 'from_dict') else p for p in d["advisories"]]
                if "isGameCenterEnabled" in d:
                    v["isGameCenterEnabled"] = bool.from_dict(d["isGameCenterEnabled"]) if hasattr(bool, 'from_dict') else d["isGameCenterEnabled"]
                if "kind" in d:
                    v["kind"] = str.from_dict(d["kind"]) if hasattr(str, 'from_dict') else d["kind"]
                if "features" in d:
                    v["features"] = [str.from_dict(p) if hasattr(str, 'from_dict') else p for p in d["features"]]
                if "minimumOsVersion" in d:
                    v["minimumOsVersion"] = str.from_dict(d["minimumOsVersion"]) if hasattr(str, 'from_dict') else d["minimumOsVersion"]
                if "trackCensoredName" in d:
                    v["trackCensoredName"] = str.from_dict(d["trackCensoredName"]) if hasattr(str, 'from_dict') else d["trackCensoredName"]
                if "languageCodesISO2A" in d:
                    v["languageCodesISO2A"] = [str.from_dict(p) if hasattr(str, 'from_dict') else p for p in d["languageCodesISO2A"]]
                if "fileSizeBytes" in d:
                    v["fileSizeBytes"] = str.from_dict(d["fileSizeBytes"]) if hasattr(str, 'from_dict') else d["fileSizeBytes"]
                if "formattedPrice" in d:
                    v["formattedPrice"] = str.from_dict(d["formattedPrice"]) if hasattr(str, 'from_dict') else d["formattedPrice"]
                if "contentAdvisoryRating" in d:
                    v["contentAdvisoryRating"] = str.from_dict(d["contentAdvisoryRating"]) if hasattr(str, 'from_dict') else d["contentAdvisoryRating"]
                if "averageUserRatingForCurrentVersion" in d:
                    v["averageUserRatingForCurrentVersion"] = float.from_dict(d["averageUserRatingForCurrentVersion"]) if hasattr(float, 'from_dict') else d["averageUserRatingForCurrentVersion"]
                if "userRatingCountForCurrentVersion" in d:
                    v["userRatingCountForCurrentVersion"] = int.from_dict(d["userRatingCountForCurrentVersion"]) if hasattr(int, 'from_dict') else d["userRatingCountForCurrentVersion"]
                if "averageUserRating" in d:
                    v["averageUserRating"] = float.from_dict(d["averageUserRating"]) if hasattr(float, 'from_dict') else d["averageUserRating"]
                if "trackViewUrl" in d:
                    v["trackViewUrl"] = str.from_dict(d["trackViewUrl"]) if hasattr(str, 'from_dict') else d["trackViewUrl"]
                if "trackContentRating" in d:
                    v["trackContentRating"] = str.from_dict(d["trackContentRating"]) if hasattr(str, 'from_dict') else d["trackContentRating"]
                if "releaseDate" in d:
                    v["releaseDate"] = str.from_dict(d["releaseDate"]) if hasattr(str, 'from_dict') else d["releaseDate"]
                if "genreIds" in d:
                    v["genreIds"] = [str.from_dict(p) if hasattr(str, 'from_dict') else p for p in d["genreIds"]]
                if "primaryGenreName" in d:
                    v["primaryGenreName"] = str.from_dict(d["primaryGenreName"]) if hasattr(str, 'from_dict') else d["primaryGenreName"]
                if "trackId" in d:
                    v["trackId"] = int.from_dict(d["trackId"]) if hasattr(int, 'from_dict') else d["trackId"]
                if "trackName" in d:
                    v["trackName"] = str.from_dict(d["trackName"]) if hasattr(str, 'from_dict') else d["trackName"]
                if "sellerName" in d:
                    v["sellerName"] = str.from_dict(d["sellerName"]) if hasattr(str, 'from_dict') else d["sellerName"]
                if "isVppDeviceBasedLicensingEnabled" in d:
                    v["isVppDeviceBasedLicensingEnabled"] = bool.from_dict(d["isVppDeviceBasedLicensingEnabled"]) if hasattr(bool, 'from_dict') else d["isVppDeviceBasedLicensingEnabled"]
                if "currentVersionReleaseDate" in d:
                    v["currentVersionReleaseDate"] = str.from_dict(d["currentVersionReleaseDate"]) if hasattr(str, 'from_dict') else d["currentVersionReleaseDate"]
                if "releaseNotes" in d:
                    v["releaseNotes"] = str.from_dict(d["releaseNotes"]) if hasattr(str, 'from_dict') else d["releaseNotes"]
                if "primaryGenreId" in d:
                    v["primaryGenreId"] = int.from_dict(d["primaryGenreId"]) if hasattr(int, 'from_dict') else d["primaryGenreId"]
                if "currency" in d:
                ...
                if "wrapperType" in d:
                    v["wrapperType"] = str.from_dict(d["wrapperType"]) if hasattr(str, 'from_dict') else d["wrapperType"]
                if "artistId" in d:
                ...
                if "genres" in d:
                    v["genres"] = [str.from_dict(p) if hasattr(str, 'from_dict') else p for p in d["genres"]]
                if "price" in d:
                    v["price"] = float.from_dict(d["price"]) if hasattr(float, 'from_dict') else d["price"]
                if "description" in d:
                    v["description"] = str.from_dict(d["description"]) if hasattr(str, 'from_dict') else d["description"]
                if "bundleId" in d:
                    v["bundleId"] = str.from_dict(d["bundleId"]) if hasattr(str, 'from_dict') else d["bundleId"]
                if "userRatingCount" in d:
                    v["userRatingCount"] = int.from_dict(d["userRatingCount"]) if hasattr(int, 'from_dict') else d["userRatingCount"]
            ...
            def as_dict(self):
                ...
                if self.__appletvScreenshotUrls is not None:
                    d['appletvScreenshotUrls'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__appletvScreenshotUrls]
                if self.__screenshotUrls is not None:
                    d['screenshotUrls'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__screenshotUrls]
                if self.__ipadScreenshotUrls is not None:
                    d['ipadScreenshotUrls'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__ipadScreenshotUrls]
                if self.__artworkUrl60 is not None:
                    d['artworkUrl60'] = self.__artworkUrl60.as_dict() if hasattr(self.__artworkUrl60, 'as_dict') else self.__artworkUrl60
                if self.__artworkUrl512 is not None:
                    d['artworkUrl512'] = self.__artworkUrl512.as_dict() if hasattr(self.__artworkUrl512, 'as_dict') else self.__artworkUrl512
                if self.__artworkUrl100 is not None:
                    d['artworkUrl100'] = self.__artworkUrl100.as_dict() if hasattr(self.__artworkUrl100, 'as_dict') else self.__artworkUrl100
                if self.__artistViewUrl is not None:
                    d['artistViewUrl'] = self.__artistViewUrl.as_dict() if hasattr(self.__artistViewUrl, 'as_dict') else self.__artistViewUrl
                if self.__supportedDevices is not None:
                    d['supportedDevices'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__supportedDevices]
                if self.__advisories is not None:
                    d['advisories'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__advisories]
                if self.__isGameCenterEnabled is not None:
                    d['isGameCenterEnabled'] = self.__isGameCenterEnabled.as_dict() if hasattr(self.__isGameCenterEnabled, 'as_dict') else self.__isGameCenterEnabled
                if self.__kind is not None:
                    d['kind'] = self.__kind.as_dict() if hasattr(self.__kind, 'as_dict') else self.__kind
                if self.__features is not None:
                    d['features'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__features]
                if self.__minimumOsVersion is not None:
                    d['minimumOsVersion'] = self.__minimumOsVersion.as_dict() if hasattr(self.__minimumOsVersion, 'as_dict') else self.__minimumOsVersion
                if self.__trackCensoredName is not None:
                    d['trackCensoredName'] = self.__trackCensoredName.as_dict() if hasattr(self.__trackCensoredName, 'as_dict') else self.__trackCensoredName
                if self.__languageCodesISO2A is not None:
                    d['languageCodesISO2A'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__languageCodesISO2A]
                if self.__fileSizeBytes is not None:
                    d['fileSizeBytes'] = self.__fileSizeBytes.as_dict() if hasattr(self.__fileSizeBytes, 'as_dict') else self.__fileSizeBytes
                if self.__formattedPrice is not None:
                    d['formattedPrice'] = self.__formattedPrice.as_dict() if hasattr(self.__formattedPrice, 'as_dict') else self.__formattedPrice
                if self.__contentAdvisoryRating is not None:
                    d['contentAdvisoryRating'] = self.__contentAdvisoryRating.as_dict() if hasattr(self.__contentAdvisoryRating, 'as_dict') else self.__contentAdvisoryRating
                if self.__averageUserRatingForCurrentVersion is not None:
                    d['averageUserRatingForCurrentVersion'] = self.__averageUserRatingForCurrentVersion.as_dict() if hasattr(self.__averageUserRatingForCurrentVersion, 'as_dict') else self.__averageUserRatingForCurrentVersion
                if self.__userRatingCountForCurrentVersion is not None:
                    d['userRatingCountForCurrentVersion'] = self.__userRatingCountForCurrentVersion.as_dict() if hasattr(self.__userRatingCountForCurrentVersion, 'as_dict') else self.__userRatingCountForCurrentVersion
                if self.__averageUserRating is not None:
                    d['averageUserRating'] = self.__averageUserRating.as_dict() if hasattr(self.__averageUserRating, 'as_dict') else self.__averageUserRating
                if self.__trackViewUrl is not None:
                    d['trackViewUrl'] = self.__trackViewUrl.as_dict() if hasattr(self.__trackViewUrl, 'as_dict') else self.__trackViewUrl
                if self.__trackContentRating is not None:
                    d['trackContentRating'] = self.__trackContentRating.as_dict() if hasattr(self.__trackContentRating, 'as_dict') else self.__trackContentRating
                ...
                if self.__genreIds is not None:
                    d['genreIds'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__genreIds]
                if self.__primaryGenreName is not None:
                    d['primaryGenreName'] = self.__primaryGenreName.as_dict() if hasattr(self.__primaryGenreName, 'as_dict') else self.__primaryGenreName
                if self.__trackId is not None:
                    d['trackId'] = self.__trackId.as_dict() if hasattr(self.__trackId, 'as_dict') else self.__trackId
                if self.__trackName is not None:
                    d['trackName'] = self.__trackName.as_dict() if hasattr(self.__trackName, 'as_dict') else self.__trackName
                if self.__sellerName is not None:
                    d['sellerName'] = self.__sellerName.as_dict() if hasattr(self.__sellerName, 'as_dict') else self.__sellerName
                if self.__isVppDeviceBasedLicensingEnabled is not None:
                    d['isVppDeviceBasedLicensingEnabled'] = self.__isVppDeviceBasedLicensingEnabled.as_dict() if hasattr(self.__isVppDeviceBasedLicensingEnabled, 'as_dict') else self.__isVppDeviceBasedLicensingEnabled
                if self.__currentVersionReleaseDate is not None:
                    d['currentVersionReleaseDate'] = self.__currentVersionReleaseDate.as_dict() if hasattr(self.__currentVersionReleaseDate, 'as_dict') else self.__currentVersionReleaseDate
                ...
                if self.__primaryGenreId is not None:
                    d['primaryGenreId'] = self.__primaryGenreId.as_dict() if hasattr(self.__primaryGenreId, 'as_dict') else self.__primaryGenreId
                ...
                if self.__wrapperType is not None:
                    d['wrapperType'] = self.__wrapperType.as_dict() if hasattr(self.__wrapperType, 'as_dict') else self.__wrapperType
                ...
                if self.__genres is not None:
                    d['genres'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__genres]
    ...
    _validations_map = {
        'resultCount': { 'required': True,},
        'results': { 'required': True,},
    }

    def __init__(self
            , resultCount: int=None            , results: List[_results]
=None            ):
        pass
    ...
    def from_dict(d):
        v = {}
        if "resultCount" in d:
            v["resultCount"] = int.from_dict(d["resultCount"]) if hasattr(int, 'from_dict') else d["resultCount"]
        if "results" in d:
            v["results"] = [ItunesLookupResp._results.from_dict(p) if hasattr(ItunesLookupResp._results, 'from_dict') else p for p in d["results"]]
    ...
    def as_dict(self):
        ...
        if self.__resultCount is not None:
            d['resultCount'] = self.__resultCount.as_dict() if hasattr(self.__resultCount, 'as_dict') else self.__resultCount
        if self.__results is not None:
            d['results'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__results]
        return d

    def __repr__(self):
        return "<Class ItunesLookupResp. resultCount: {}, results: {}>".format(limitedRepr(self.__resultCount[:20] if isinstance(self.__resultCount, bytes) else self.__resultCount), limitedRepr(self.__results[:20] if isinstance(self.__results, bytes) else self.__results))
