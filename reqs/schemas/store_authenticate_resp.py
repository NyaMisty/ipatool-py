...
class StoreAuthenticateResp:
    class _action:
            ...
            def __repr__(self):
                return "<Class _action. kind: {}>".format(limitedRepr(self.__kind[:20] if isinstance(self.__kind, bytes) else self.__kind))
    ...
    class _accountFlags:
            ...
            _validations_map = {
                ...
                'underThirteen': { 'required': True,},
                'identityLastVerified': { 'required': True,},
                'verifiedExpirationDate': { 'required': True,},
                'retailDemo': { 'required': True,},
                'autoPlay': { 'required': True,},
                'isDisabledAccount': { 'required': True,},
                'isRestrictedAccount': { 'required': True,},
                'isManagedAccount': { 'required': True,},
                'isInRestrictedRegion': { 'required': True,},
                'accountFlagsVersion': { 'required': True,},
                'hasAgreedToTerms': { 'required': True,},
                'hasAgreedToAppClipTerms': { 'required': True,},
                'hasWatchHardwareOffer': { 'required': True,},
                'isInFamily': { 'required': True,},
                'hasSubscriptionFamilySharingEnabled': { 'required': True,},
            }

            def __init__(self
                    , personalization: bool=None            , underThirteen: bool=None            , identityLastVerified: int=None            , verifiedExpirationDate: int=None            , retailDemo: bool=None            , autoPlay: bool=None            , isDisabledAccount: bool=None            , isRestrictedAccount: bool=None            , isManagedAccount: bool=None            , isInRestrictedRegion: bool=None            , accountFlagsVersion: int=None            , hasAgreedToTerms: bool=None            , hasAgreedToAppClipTerms: bool=None            , hasWatchHardwareOffer: bool=None            , isInFamily: bool=None            , hasSubscriptionFamilySharingEnabled: bool=None            ):
                pass
                ...
                self.__hasSubscriptionFamilySharingEnabled = hasSubscriptionFamilySharingEnabled
            ...
            identityLastVerified = property(_get_identityLastVerified, _set_identityLastVerified)
            ...
            verifiedExpirationDate = property(_get_verifiedExpirationDate, _set_verifiedExpirationDate)
            ...
            isRestrictedAccount = property(_get_isRestrictedAccount, _set_isRestrictedAccount)
            ...
            isInRestrictedRegion = property(_get_isInRestrictedRegion, _set_isInRestrictedRegion)
            ...
            accountFlagsVersion = property(_get_accountFlagsVersion, _set_accountFlagsVersion)
            ...
            hasAgreedToAppClipTerms = property(_get_hasAgreedToAppClipTerms, _set_hasAgreedToAppClipTerms)
            ...
            hasWatchHardwareOffer = property(_get_hasWatchHardwareOffer, _set_hasWatchHardwareOffer)
            ...
            hasSubscriptionFamilySharingEnabled = property(_get_hasSubscriptionFamilySharingEnabled, _set_hasSubscriptionFamilySharingEnabled)
            ...
            def from_dict(d):
                ...
                if "personalization" in d:
                    v["personalization"] = bool.from_dict(d["personalization"]) if hasattr(bool, 'from_dict') else d["personalization"]
                if "underThirteen" in d:
                    v["underThirteen"] = bool.from_dict(d["underThirteen"]) if hasattr(bool, 'from_dict') else d["underThirteen"]
                if "identityLastVerified" in d:
                    v["identityLastVerified"] = int.from_dict(d["identityLastVerified"]) if hasattr(int, 'from_dict') else d["identityLastVerified"]
                if "verifiedExpirationDate" in d:
                    v["verifiedExpirationDate"] = int.from_dict(d["verifiedExpirationDate"]) if hasattr(int, 'from_dict') else d["verifiedExpirationDate"]
                if "retailDemo" in d:
                    v["retailDemo"] = bool.from_dict(d["retailDemo"]) if hasattr(bool, 'from_dict') else d["retailDemo"]
                if "autoPlay" in d:
                    v["autoPlay"] = bool.from_dict(d["autoPlay"]) if hasattr(bool, 'from_dict') else d["autoPlay"]
                if "isDisabledAccount" in d:
                    v["isDisabledAccount"] = bool.from_dict(d["isDisabledAccount"]) if hasattr(bool, 'from_dict') else d["isDisabledAccount"]
                if "isRestrictedAccount" in d:
                    v["isRestrictedAccount"] = bool.from_dict(d["isRestrictedAccount"]) if hasattr(bool, 'from_dict') else d["isRestrictedAccount"]
                if "isManagedAccount" in d:
                    v["isManagedAccount"] = bool.from_dict(d["isManagedAccount"]) if hasattr(bool, 'from_dict') else d["isManagedAccount"]
                if "isInRestrictedRegion" in d:
                    v["isInRestrictedRegion"] = bool.from_dict(d["isInRestrictedRegion"]) if hasattr(bool, 'from_dict') else d["isInRestrictedRegion"]
                if "accountFlagsVersion" in d:
                    v["accountFlagsVersion"] = int.from_dict(d["accountFlagsVersion"]) if hasattr(int, 'from_dict') else d["accountFlagsVersion"]
                if "hasAgreedToTerms" in d:
                    v["hasAgreedToTerms"] = bool.from_dict(d["hasAgreedToTerms"]) if hasattr(bool, 'from_dict') else d["hasAgreedToTerms"]
                if "hasAgreedToAppClipTerms" in d:
                    v["hasAgreedToAppClipTerms"] = bool.from_dict(d["hasAgreedToAppClipTerms"]) if hasattr(bool, 'from_dict') else d["hasAgreedToAppClipTerms"]
                if "hasWatchHardwareOffer" in d:
                    v["hasWatchHardwareOffer"] = bool.from_dict(d["hasWatchHardwareOffer"]) if hasattr(bool, 'from_dict') else d["hasWatchHardwareOffer"]
                if "isInFamily" in d:
                    v["isInFamily"] = bool.from_dict(d["isInFamily"]) if hasattr(bool, 'from_dict') else d["isInFamily"]
                if "hasSubscriptionFamilySharingEnabled" in d:
                    v["hasSubscriptionFamilySharingEnabled"] = bool.from_dict(d["hasSubscriptionFamilySharingEnabled"]) if hasattr(bool, 'from_dict') else d["hasSubscriptionFamilySharingEnabled"]
            ...
            def as_dict(self):
                ...
                if self.__personalization is not None:
                    d['personalization'] = self.__personalization.as_dict() if hasattr(self.__personalization, 'as_dict') else self.__personalization
                if self.__underThirteen is not None:
                    d['underThirteen'] = self.__underThirteen.as_dict() if hasattr(self.__underThirteen, 'as_dict') else self.__underThirteen
                if self.__identityLastVerified is not None:
                    d['identityLastVerified'] = self.__identityLastVerified.as_dict() if hasattr(self.__identityLastVerified, 'as_dict') else self.__identityLastVerified
                if self.__verifiedExpirationDate is not None:
                    d['verifiedExpirationDate'] = self.__verifiedExpirationDate.as_dict() if hasattr(self.__verifiedExpirationDate, 'as_dict') else self.__verifiedExpirationDate
                if self.__retailDemo is not None:
                    d['retailDemo'] = self.__retailDemo.as_dict() if hasattr(self.__retailDemo, 'as_dict') else self.__retailDemo
                if self.__autoPlay is not None:
                    d['autoPlay'] = self.__autoPlay.as_dict() if hasattr(self.__autoPlay, 'as_dict') else self.__autoPlay
                if self.__isDisabledAccount is not None:
                    d['isDisabledAccount'] = self.__isDisabledAccount.as_dict() if hasattr(self.__isDisabledAccount, 'as_dict') else self.__isDisabledAccount
                if self.__isRestrictedAccount is not None:
                    d['isRestrictedAccount'] = self.__isRestrictedAccount.as_dict() if hasattr(self.__isRestrictedAccount, 'as_dict') else self.__isRestrictedAccount
                if self.__isManagedAccount is not None:
                    d['isManagedAccount'] = self.__isManagedAccount.as_dict() if hasattr(self.__isManagedAccount, 'as_dict') else self.__isManagedAccount
                if self.__isInRestrictedRegion is not None:
                    d['isInRestrictedRegion'] = self.__isInRestrictedRegion.as_dict() if hasattr(self.__isInRestrictedRegion, 'as_dict') else self.__isInRestrictedRegion
                if self.__accountFlagsVersion is not None:
                    d['accountFlagsVersion'] = self.__accountFlagsVersion.as_dict() if hasattr(self.__accountFlagsVersion, 'as_dict') else self.__accountFlagsVersion
                if self.__hasAgreedToTerms is not None:
                    d['hasAgreedToTerms'] = self.__hasAgreedToTerms.as_dict() if hasattr(self.__hasAgreedToTerms, 'as_dict') else self.__hasAgreedToTerms
                if self.__hasAgreedToAppClipTerms is not None:
                    d['hasAgreedToAppClipTerms'] = self.__hasAgreedToAppClipTerms.as_dict() if hasattr(self.__hasAgreedToAppClipTerms, 'as_dict') else self.__hasAgreedToAppClipTerms
                if self.__hasWatchHardwareOffer is not None:
                    d['hasWatchHardwareOffer'] = self.__hasWatchHardwareOffer.as_dict() if hasattr(self.__hasWatchHardwareOffer, 'as_dict') else self.__hasWatchHardwareOffer
                if self.__isInFamily is not None:
                    d['isInFamily'] = self.__isInFamily.as_dict() if hasattr(self.__isInFamily, 'as_dict') else self.__isInFamily
                if self.__hasSubscriptionFamilySharingEnabled is not None:
                    d['hasSubscriptionFamilySharingEnabled'] = self.__hasSubscriptionFamilySharingEnabled.as_dict() if hasattr(self.__hasSubscriptionFamilySharingEnabled, 'as_dict') else self.__hasSubscriptionFamilySharingEnabled
                return d

            def __repr__(self):
                return "<Class _accountFlags. personalization: {}, underThirteen: {}, identityLastVerified: {}, verifiedExpirationDate: {}, retailDemo: {}, autoPlay: {}, isDisabledAccount: {}, isRestrictedAccount: {}, isManagedAccount: {}, isInRestrictedRegion: {}, accountFlagsVersion: {}, hasAgreedToTerms: {}, hasAgreedToAppClipTerms: {}, hasWatchHardwareOffer: {}, isInFamily: {}, hasSubscriptionFamilySharingEnabled: {}>".format(limitedRepr(self.__personalization[:20] if isinstance(self.__personalization, bytes) else self.__personalization), limitedRepr(self.__underThirteen[:20] if isinstance(self.__underThirteen, bytes) else self.__underThirteen), limitedRepr(self.__identityLastVerified[:20] if isinstance(self.__identityLastVerified, bytes) else self.__identityLastVerified), limitedRepr(self.__verifiedExpirationDate[:20] if isinstance(self.__verifiedExpirationDate, bytes) else self.__verifiedExpirationDate), limitedRepr(self.__retailDemo[:20] if isinstance(self.__retailDemo, bytes) else self.__retailDemo), limitedRepr(self.__autoPlay[:20] if isinstance(self.__autoPlay, bytes) else self.__autoPlay), limitedRepr(self.__isDisabledAccount[:20] if isinstance(self.__isDisabledAccount, bytes) else self.__isDisabledAccount), limitedRepr(self.__isRestrictedAccount[:20] if isinstance(self.__isRestrictedAccount, bytes) else self.__isRestrictedAccount), limitedRepr(self.__isManagedAccount[:20] if isinstance(self.__isManagedAccount, bytes) else self.__isManagedAccount), limitedRepr(self.__isInRestrictedRegion[:20] if isinstance(self.__isInRestrictedRegion, bytes) else self.__isInRestrictedRegion), limitedRepr(self.__accountFlagsVersion[:20] if isinstance(self.__accountFlagsVersion, bytes) else self.__accountFlagsVersion), limitedRepr(self.__hasAgreedToTerms[:20] if isinstance(self.__hasAgreedToTerms, bytes) else self.__hasAgreedToTerms), limitedRepr(self.__hasAgreedToAppClipTerms[:20] if isinstance(self.__hasAgreedToAppClipTerms, bytes) else self.__hasAgreedToAppClipTerms), limitedRepr(self.__hasWatchHardwareOffer[:20] if isinstance(self.__hasWatchHardwareOffer, bytes) else self.__hasWatchHardwareOffer), limitedRepr(self.__isInFamily[:20] if isinstance(self.__isInFamily, bytes) else self.__isInFamily), limitedRepr(self.__hasSubscriptionFamilySharingEnabled[:20] if isinstance(self.__hasSubscriptionFamilySharingEnabled, bytes) else self.__hasSubscriptionFamilySharingEnabled))
    ...
    class _subscriptionStatus:
        ...
        =None            , account: _account=None            , family: _family=None            ):
            ...
            def _set_terms(self, value):
                ...
                if  not all(isinstance(i, StoreAuthenticateResp._subscriptionStatus._terms) for i in value):
                    raise TypeError("terms list values must be StoreAuthenticateResp._subscriptionStatus._terms")
            ...
            def _set_account(self, value):
                if  not isinstance(value, StoreAuthenticateResp._subscriptionStatus._account):
                    raise TypeError("account must be StoreAuthenticateResp._subscriptionStatus._account")
            ...
            def _set_family(self, value):
                if  not isinstance(value, StoreAuthenticateResp._subscriptionStatus._family):
                    raise TypeError("family must be StoreAuthenticateResp._subscriptionStatus._family")
            ...
            def from_dict(d):
                v = {}
                if "terms" in d:
                    v["terms"] = [StoreAuthenticateResp._subscriptionStatus._terms.from_dict(p) if hasattr(StoreAuthenticateResp._subscriptionStatus._terms, 'from_dict') else p for p in d["terms"]]
                if "account" in d:
                    v["account"] = StoreAuthenticateResp._subscriptionStatus._account.from_dict(d["account"]) if hasattr(StoreAuthenticateResp._subscriptionStatus._account, 'from_dict') else d["account"]
                if "family" in d:
                    v["family"] = StoreAuthenticateResp._subscriptionStatus._family.from_dict(d["family"]) if hasattr(StoreAuthenticateResp._subscriptionStatus._family, 'from_dict') else d["family"]
    ...
    class _privacyAcknowledgement:
            ...
            _validations_map = {
                'com_apple_onboarding_appstore': { 'required': True,},
                'com_apple_onboarding_applemusic': { 'required': True,},
                'com_apple_onboarding_videos': { 'required': True,},
                'com_apple_onboarding_itunesstore': { 'required': True,},
                'com_apple_onboarding_itunesu': { 'required': True,},
                'com_apple_onboarding_applearcade': { 'required': True,},
            }

            def __init__(self
                    , com_apple_onboarding_appstore: int=None            , com_apple_onboarding_applemusic: int=None            , com_apple_onboarding_videos: int=None            , com_apple_onboarding_itunesstore: int=None            , com_apple_onboarding_itunesu: int=None            , com_apple_onboarding_applearcade: int=None            ):
                pass
            ...
            com_apple_onboarding_appstore = property(_get_com_apple_onboarding_appstore, _set_com_apple_onboarding_appstore)
            ...
            com_apple_onboarding_applemusic = property(_get_com_apple_onboarding_applemusic, _set_com_apple_onboarding_applemusic)
            ...
            com_apple_onboarding_videos = property(_get_com_apple_onboarding_videos, _set_com_apple_onboarding_videos)
            ...
            com_apple_onboarding_itunesstore = property(_get_com_apple_onboarding_itunesstore, _set_com_apple_onboarding_itunesstore)
            ...
            com_apple_onboarding_itunesu = property(_get_com_apple_onboarding_itunesu, _set_com_apple_onboarding_itunesu)
            ...
            com_apple_onboarding_applearcade = property(_get_com_apple_onboarding_applearcade, _set_com_apple_onboarding_applearcade)
            ...
            def from_dict(d):
                ...
                if "com.apple.onboarding.appstore" in d:
                    v["com_apple_onboarding_appstore"] = int.from_dict(d["com.apple.onboarding.appstore"]) if hasattr(int, 'from_dict') else d["com.apple.onboarding.appstore"]
                if "com.apple.onboarding.applemusic" in d:
                    v["com_apple_onboarding_applemusic"] = int.from_dict(d["com.apple.onboarding.applemusic"]) if hasattr(int, 'from_dict') else d["com.apple.onboarding.applemusic"]
                if "com.apple.onboarding.videos" in d:
                    v["com_apple_onboarding_videos"] = int.from_dict(d["com.apple.onboarding.videos"]) if hasattr(int, 'from_dict') else d["com.apple.onboarding.videos"]
                if "com.apple.onboarding.itunesstore" in d:
                    v["com_apple_onboarding_itunesstore"] = int.from_dict(d["com.apple.onboarding.itunesstore"]) if hasattr(int, 'from_dict') else d["com.apple.onboarding.itunesstore"]
                if "com.apple.onboarding.itunesu" in d:
                    v["com_apple_onboarding_itunesu"] = int.from_dict(d["com.apple.onboarding.itunesu"]) if hasattr(int, 'from_dict') else d["com.apple.onboarding.itunesu"]
                if "com.apple.onboarding.applearcade" in d:
                    v["com_apple_onboarding_applearcade"] = int.from_dict(d["com.apple.onboarding.applearcade"]) if hasattr(int, 'from_dict') else d["com.apple.onboarding.applearcade"]
            ...
            def as_dict(self):
                ...
                if self.__com_apple_onboarding_appstore is not None:
                    d['com.apple.onboarding.appstore'] = self.__com_apple_onboarding_appstore.as_dict() if hasattr(self.__com_apple_onboarding_appstore, 'as_dict') else self.__com_apple_onboarding_appstore
                if self.__com_apple_onboarding_applemusic is not None:
                    d['com.apple.onboarding.applemusic'] = self.__com_apple_onboarding_applemusic.as_dict() if hasattr(self.__com_apple_onboarding_applemusic, 'as_dict') else self.__com_apple_onboarding_applemusic
                if self.__com_apple_onboarding_videos is not None:
                    d['com.apple.onboarding.videos'] = self.__com_apple_onboarding_videos.as_dict() if hasattr(self.__com_apple_onboarding_videos, 'as_dict') else self.__com_apple_onboarding_videos
                if self.__com_apple_onboarding_itunesstore is not None:
                    d['com.apple.onboarding.itunesstore'] = self.__com_apple_onboarding_itunesstore.as_dict() if hasattr(self.__com_apple_onboarding_itunesstore, 'as_dict') else self.__com_apple_onboarding_itunesstore
                if self.__com_apple_onboarding_itunesu is not None:
                    d['com.apple.onboarding.itunesu'] = self.__com_apple_onboarding_itunesu.as_dict() if hasattr(self.__com_apple_onboarding_itunesu, 'as_dict') else self.__com_apple_onboarding_itunesu
                if self.__com_apple_onboarding_applearcade is not None:
                    d['com.apple.onboarding.applearcade'] = self.__com_apple_onboarding_applearcade.as_dict() if hasattr(self.__com_apple_onboarding_applearcade, 'as_dict') else self.__com_apple_onboarding_applearcade
                return d

            def __repr__(self):
                return "<Class _privacyAcknowledgement. com_apple_onboarding_appstore: {}, com_apple_onboarding_applemusic: {}, com_apple_onboarding_videos: {}, com_apple_onboarding_itunesstore: {}, com_apple_onboarding_itunesu: {}, com_apple_onboarding_applearcade: {}>".format(limitedRepr(self.__com_apple_onboarding_appstore[:20] if isinstance(self.__com_apple_onboarding_appstore, bytes) else self.__com_apple_onboarding_appstore), limitedRepr(self.__com_apple_onboarding_applemusic[:20] if isinstance(self.__com_apple_onboarding_applemusic, bytes) else self.__com_apple_onboarding_applemusic), limitedRepr(self.__com_apple_onboarding_videos[:20] if isinstance(self.__com_apple_onboarding_videos, bytes) else self.__com_apple_onboarding_videos), limitedRepr(self.__com_apple_onboarding_itunesstore[:20] if isinstance(self.__com_apple_onboarding_itunesstore, bytes) else self.__com_apple_onboarding_itunesstore), limitedRepr(self.__com_apple_onboarding_itunesu[:20] if isinstance(self.__com_apple_onboarding_itunesu, bytes) else self.__com_apple_onboarding_itunesu), limitedRepr(self.__com_apple_onboarding_applearcade[:20] if isinstance(self.__com_apple_onboarding_applearcade, bytes) else self.__com_apple_onboarding_applearcade))
    ...
    class _accountInfo:
            class _address:
                    ...
                    def from_dict(d):
                        v = {}
                        if "firstName" in d:
                            v["firstName"] = str.from_dict(d["firstName"]) if hasattr(str, 'from_dict') else d["firstName"]
                        if "lastName" in d:
                            v["lastName"] = str.from_dict(d["lastName"]) if hasattr(str, 'from_dict') else d["lastName"]
                    ...
                    def as_dict(self):
                        ...
                        if self.__firstName is not None:
                            d['firstName'] = self.__firstName.as_dict() if hasattr(self.__firstName, 'as_dict') else self.__firstName
                        if self.__lastName is not None:
                            d['lastName'] = self.__lastName.as_dict() if hasattr(self.__lastName, 'as_dict') else self.__lastName
                        return d

                    def __repr__(self):
                        return "<Class _address. firstName: {}, lastName: {}>".format(limitedRepr(self.__firstName[:20] if isinstance(self.__firstName, bytes) else self.__firstName), limitedRepr(self.__lastName[:20] if isinstance(self.__lastName, bytes) else self.__lastName))
            ...
            _validations_map = {
                'appleId': { 'required': True,},
                'address': { 'required': True,},
            }

            def __init__(self
                    , appleId: str=None            , address: _address=None            ):
                pass
            ...
            def _set_address(self, value):
                if  not isinstance(value, StoreAuthenticateResp._accountInfo._address):
                    raise TypeError("address must be StoreAuthenticateResp._accountInfo._address")
            ...
            def from_dict(d):
                v = {}
                if "appleId" in d:
                    v["appleId"] = str.from_dict(d["appleId"]) if hasattr(str, 'from_dict') else d["appleId"]
                if "address" in d:
                    v["address"] = StoreAuthenticateResp._accountInfo._address.from_dict(d["address"]) if hasattr(StoreAuthenticateResp._accountInfo._address, 'from_dict') else d["address"]
            ...
            def as_dict(self):
                ...
                if self.__appleId is not None:
                    d['appleId'] = self.__appleId.as_dict() if hasattr(self.__appleId, 'as_dict') else self.__appleId
                if self.__address is not None:
                    d['address'] = self.__address.as_dict() if hasattr(self.__address, 'as_dict') else self.__address
                return d

            def __repr__(self):
                return "<Class _accountInfo. appleId: {}, address: {}>".format(limitedRepr(self.__appleId[:20] if isinstance(self.__appleId, bytes) else self.__appleId), limitedRepr(self.__address[:20] if isinstance(self.__address, bytes) else self.__address))
    ...
    class _dialog:
            ...
            def __init__(self
                    , m_allowed: bool=None            , message: str=None            , explanation: str=None            , defaultButton: str=None            , okButtonString: str=None            , initialCheckboxValue: bool=None            ):
                pass
            ...
            def __repr__(self):
                return "<Class _dialog. m_allowed: {}, message: {}, explanation: {}, defaultButton: {}, okButtonString: {}, initialCheckboxValue: {}>".format(limitedRepr(self.__m_allowed[:20] if isinstance(self.__m_allowed, bytes) else self.__m_allowed), limitedRepr(self.__message[:20] if isinstance(self.__message, bytes) else self.__message), limitedRepr(self.__explanation[:20] if isinstance(self.__explanation, bytes) else self.__explanation), limitedRepr(self.__defaultButton[:20] if isinstance(self.__defaultButton, bytes) else self.__defaultButton), limitedRepr(self.__okButtonString[:20] if isinstance(self.__okButtonString, bytes) else self.__okButtonString), limitedRepr(self.__initialCheckboxValue[:20] if isinstance(self.__initialCheckboxValue, bytes) else self.__initialCheckboxValue))
    ...
    _validations_map = {
        ...
        'accountInfo': { 'required': True,},
        'passwordToken': { 'required': True,},
        'clearToken': { 'required': True,},
        'm_allowed': { 'required': True,},
        'is_cloud_enabled': { 'required': True,},
        'dsPersonId': { 'required': True,},
        'creditDisplay': { 'required': True,},
        'creditBalance': { 'required': True,},
        'freeSongBalance': { 'required': True,},
        'isManagedStudent': { 'required': True,},
        'action': { 'required': True,},
        'subscriptionStatus': { 'required': True,},
        'accountFlags': { 'required': True,},
        'status': { 'required': True,},
        'download_queue_info': { 'required': True,},
        'privacyAcknowledgement': { 'required': True,},
        'dialog': { 'required': True,},
    }

    def __init__(self
            , pings: List[float]
=None            , cancel_purchase_batch: bool=None            , customerMessage: str=None            , failureType: str=None            , accountInfo: _accountInfo=None            , passwordToken: str=None            , clearToken: str=None            , m_allowed: bool=None            , is_cloud_enabled: str=None            , dsPersonId: str=None            , creditDisplay: str=None            , creditBalance: str=None            , freeSongBalance: str=None            , isManagedStudent: bool=None            , action: _action=None            , subscriptionStatus: _subscriptionStatus=None            , accountFlags: _accountFlags=None            , status: int=None            , download_queue_info: _download_queue_info=None            , privacyAcknowledgement: _privacyAcknowledgement=None            , dialog: _dialog=None            ):
        pass
        self.__pings = pings
    ...
    def _set_download_queue_info(self, value):
        if  not isinstance(value, StoreAuthenticateResp._download_queue_info):
            raise TypeError("download_queue_info must be StoreAuthenticateResp._download_queue_info")
    ...
    privacyAcknowledgement = property(_get_privacyAcknowledgement, _set_privacyAcknowledgement)
    ...
    def from_dict(d):
        ...
        if "accountInfo" in d:
            v["accountInfo"] = StoreAuthenticateResp._accountInfo.from_dict(d["accountInfo"]) if hasattr(StoreAuthenticateResp._accountInfo, 'from_dict') else d["accountInfo"]
        if "passwordToken" in d:
            v["passwordToken"] = str.from_dict(d["passwordToken"]) if hasattr(str, 'from_dict') else d["passwordToken"]
        if "clearToken" in d:
            v["clearToken"] = str.from_dict(d["clearToken"]) if hasattr(str, 'from_dict') else d["clearToken"]
        if "m-allowed" in d:
            v["m_allowed"] = bool.from_dict(d["m-allowed"]) if hasattr(bool, 'from_dict') else d["m-allowed"]
        if "is-cloud-enabled" in d:
            v["is_cloud_enabled"] = str.from_dict(d["is-cloud-enabled"]) if hasattr(str, 'from_dict') else d["is-cloud-enabled"]
        if "dsPersonId" in d:
        ...
        if "isManagedStudent" in d:
            v["isManagedStudent"] = bool.from_dict(d["isManagedStudent"]) if hasattr(bool, 'from_dict') else d["isManagedStudent"]
        if "action" in d:
            v["action"] = StoreAuthenticateResp._action.from_dict(d["action"]) if hasattr(StoreAuthenticateResp._action, 'from_dict') else d["action"]
        if "subscriptionStatus" in d:
            v["subscriptionStatus"] = StoreAuthenticateResp._subscriptionStatus.from_dict(d["subscriptionStatus"]) if hasattr(StoreAuthenticateResp._subscriptionStatus, 'from_dict') else d["subscriptionStatus"]
        if "accountFlags" in d:
            v["accountFlags"] = StoreAuthenticateResp._accountFlags.from_dict(d["accountFlags"]) if hasattr(StoreAuthenticateResp._accountFlags, 'from_dict') else d["accountFlags"]
        if "status" in d:
            v["status"] = int.from_dict(d["status"]) if hasattr(int, 'from_dict') else d["status"]
        if "download-queue-info" in d:
            v["download_queue_info"] = StoreAuthenticateResp._download_queue_info.from_dict(d["download-queue-info"]) if hasattr(StoreAuthenticateResp._download_queue_info, 'from_dict') else d["download-queue-info"]
        if "privacyAcknowledgement" in d:
            v["privacyAcknowledgement"] = StoreAuthenticateResp._privacyAcknowledgement.from_dict(d["privacyAcknowledgement"]) if hasattr(StoreAuthenticateResp._privacyAcknowledgement, 'from_dict') else d["privacyAcknowledgement"]
        if "dialog" in d:
            v["dialog"] = StoreAuthenticateResp._dialog.from_dict(d["dialog"]) if hasattr(StoreAuthenticateResp._dialog, 'from_dict') else d["dialog"]
    ...
    def as_dict(self):
        ...
        if self.__accountInfo is not None:
            d['accountInfo'] = self.__accountInfo.as_dict() if hasattr(self.__accountInfo, 'as_dict') else self.__accountInfo
        if self.__passwordToken is not None:
            d['passwordToken'] = self.__passwordToken.as_dict() if hasattr(self.__passwordToken, 'as_dict') else self.__passwordToken
        if self.__clearToken is not None:
            d['clearToken'] = self.__clearToken.as_dict() if hasattr(self.__clearToken, 'as_dict') else self.__clearToken
        if self.__m_allowed is not None:
            d['m-allowed'] = self.__m_allowed.as_dict() if hasattr(self.__m_allowed, 'as_dict') else self.__m_allowed
        if self.__is_cloud_enabled is not None:
            d['is-cloud-enabled'] = self.__is_cloud_enabled.as_dict() if hasattr(self.__is_cloud_enabled, 'as_dict') else self.__is_cloud_enabled
        ...
        if self.__isManagedStudent is not None:
            d['isManagedStudent'] = self.__isManagedStudent.as_dict() if hasattr(self.__isManagedStudent, 'as_dict') else self.__isManagedStudent
        if self.__action is not None:
            d['action'] = self.__action.as_dict() if hasattr(self.__action, 'as_dict') else self.__action
        ...
        if self.__accountFlags is not None:
            d['accountFlags'] = self.__accountFlags.as_dict() if hasattr(self.__accountFlags, 'as_dict') else self.__accountFlags
        ...
        if self.__privacyAcknowledgement is not None:
            d['privacyAcknowledgement'] = self.__privacyAcknowledgement.as_dict() if hasattr(self.__privacyAcknowledgement, 'as_dict') else self.__privacyAcknowledgement
        if self.__dialog is not None:
            d['dialog'] = self.__dialog.as_dict() if hasattr(self.__dialog, 'as_dict') else self.__dialog
        return d

    def __repr__(self):
        return "<Class StoreAuthenticateResp. pings: {}, cancel_purchase_batch: {}, customerMessage: {}, failureType: {}, accountInfo: {}, passwordToken: {}, clearToken: {}, m_allowed: {}, is_cloud_enabled: {}, dsPersonId: {}, creditDisplay: {}, creditBalance: {}, freeSongBalance: {}, isManagedStudent: {}, action: {}, subscriptionStatus: {}, accountFlags: {}, status: {}, download_queue_info: {}, privacyAcknowledgement: {}, dialog: {}>".format(limitedRepr(self.__pings[:20] if isinstance(self.__pings, bytes) else self.__pings), limitedRepr(self.__cancel_purchase_batch[:20] if isinstance(self.__cancel_purchase_batch, bytes) else self.__cancel_purchase_batch), limitedRepr(self.__customerMessage[:20] if isinstance(self.__customerMessage, bytes) else self.__customerMessage), limitedRepr(self.__failureType[:20] if isinstance(self.__failureType, bytes) else self.__failureType), limitedRepr(self.__accountInfo[:20] if isinstance(self.__accountInfo, bytes) else self.__accountInfo), limitedRepr(self.__passwordToken[:20] if isinstance(self.__passwordToken, bytes) else self.__passwordToken), limitedRepr(self.__clearToken[:20] if isinstance(self.__clearToken, bytes) else self.__clearToken), limitedRepr(self.__m_allowed[:20] if isinstance(self.__m_allowed, bytes) else self.__m_allowed), limitedRepr(self.__is_cloud_enabled[:20] if isinstance(self.__is_cloud_enabled, bytes) else self.__is_cloud_enabled), limitedRepr(self.__dsPersonId[:20] if isinstance(self.__dsPersonId, bytes) else self.__dsPersonId), limitedRepr(self.__creditDisplay[:20] if isinstance(self.__creditDisplay, bytes) else self.__creditDisplay), limitedRepr(self.__creditBalance[:20] if isinstance(self.__creditBalance, bytes) else self.__creditBalance), limitedRepr(self.__freeSongBalance[:20] if isinstance(self.__freeSongBalance, bytes) else self.__freeSongBalance), limitedRepr(self.__isManagedStudent[:20] if isinstance(self.__isManagedStudent, bytes) else self.__isManagedStudent), limitedRepr(self.__action[:20] if isinstance(self.__action, bytes) else self.__action), limitedRepr(self.__subscriptionStatus[:20] if isinstance(self.__subscriptionStatus, bytes) else self.__subscriptionStatus), limitedRepr(self.__accountFlags[:20] if isinstance(self.__accountFlags, bytes) else self.__accountFlags), limitedRepr(self.__status[:20] if isinstance(self.__status, bytes) else self.__status), limitedRepr(self.__download_queue_info[:20] if isinstance(self.__download_queue_info, bytes) else self.__download_queue_info), limitedRepr(self.__privacyAcknowledgement[:20] if isinstance(self.__privacyAcknowledgement, bytes) else self.__privacyAcknowledgement), limitedRepr(self.__dialog[:20] if isinstance(self.__dialog, bytes) else self.__dialog))
