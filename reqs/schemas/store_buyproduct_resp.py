...
class StoreBuyproductResp:
    class _metrics:
            ...
            _validations_map = {
                'itemIds': { 'required': False,},
                'price': { 'required': False,},
                'priceType': { 'required': False,},
                'productTypes': { 'required': False,},
                'mtApp': { 'required': True,},
                'mtClientId': { 'required': True,},
                'mtEventTime': { 'required': True,},
                'mtPageId': { 'required': True,},
                'mtPageType': { 'required': True,},
                'mtPrevPage': { 'required': True,},
                'mtRequestId': { 'required': True,},
                'mtTopic': { 'required': True,},
                'currency': { 'required': False,},
                'exchangeRateToUSD': { 'required': False,},
                'commerceEvent_purchase_priceType': { 'required': False,},
                'commerceEvent_storeFrontId': { 'required': False,},
                'commerceEvent_result_resultType': { 'required': False,},
                'commerceEvent_flowType': { 'required': False,},
                'commerceEvent_flowStep': { 'required': False,},
                'dialogId': { 'required': False,},
                'message': { 'required': False,},
                'messageCode': { 'required': False,},
                'options': { 'required': False,},
                'actionUrl': { 'required': False,},
                'asnState': { 'required': False,},
                'eventType': { 'required': False,},
            }

            def __init__(self
                    , itemIds: List[int]
        =None            , price: int=None            , priceType: str=None            , productTypes: List[str]
        =None            , mtApp: str=None            , mtClientId: str=None            , mtEventTime: str=None            , mtPageId: str=None            , mtPageType: str=None            , mtPrevPage: str=None            , mtRequestId: str=None            , mtTopic: str=None            , currency: str=None            , exchangeRateToUSD: float=None            , commerceEvent_purchase_priceType: str=None            , commerceEvent_storeFrontId: str=None            , commerceEvent_result_resultType: int=None            , commerceEvent_flowType: int=None            , commerceEvent_flowStep: int=None            , dialogId: str=None            , message: str=None            , messageCode: str=None            , options: List[str]
        =None            , actionUrl: str=None            , asnState: int=None            , eventType: str=None            ):
                pass
            ...
            commerceEvent_purchase_priceType = property(_get_commerceEvent_purchase_priceType, _set_commerceEvent_purchase_priceType)
            ...
            commerceEvent_storeFrontId = property(_get_commerceEvent_storeFrontId, _set_commerceEvent_storeFrontId)
            ...
            commerceEvent_result_resultType = property(_get_commerceEvent_result_resultType, _set_commerceEvent_result_resultType)
            ...
            commerceEvent_flowType = property(_get_commerceEvent_flowType, _set_commerceEvent_flowType)
            ...
            commerceEvent_flowStep = property(_get_commerceEvent_flowStep, _set_commerceEvent_flowStep)
            ...
            def from_dict(d):
                v = {}
                if "itemIds" in d:
                    v["itemIds"] = [int.from_dict(p) if hasattr(int, 'from_dict') else p for p in d["itemIds"]]
                if "price" in d:
                    v["price"] = int.from_dict(d["price"]) if hasattr(int, 'from_dict') else d["price"]
                if "priceType" in d:
                    v["priceType"] = str.from_dict(d["priceType"]) if hasattr(str, 'from_dict') else d["priceType"]
                if "productTypes" in d:
                    v["productTypes"] = [str.from_dict(p) if hasattr(str, 'from_dict') else p for p in d["productTypes"]]
                if "mtApp" in d:
                    v["mtApp"] = str.from_dict(d["mtApp"]) if hasattr(str, 'from_dict') else d["mtApp"]
                if "mtClientId" in d:
                    v["mtClientId"] = str.from_dict(d["mtClientId"]) if hasattr(str, 'from_dict') else d["mtClientId"]
                if "mtEventTime" in d:
                    v["mtEventTime"] = str.from_dict(d["mtEventTime"]) if hasattr(str, 'from_dict') else d["mtEventTime"]
                if "mtPageId" in d:
                    v["mtPageId"] = str.from_dict(d["mtPageId"]) if hasattr(str, 'from_dict') else d["mtPageId"]
                if "mtPageType" in d:
                    v["mtPageType"] = str.from_dict(d["mtPageType"]) if hasattr(str, 'from_dict') else d["mtPageType"]
                if "mtPrevPage" in d:
                    v["mtPrevPage"] = str.from_dict(d["mtPrevPage"]) if hasattr(str, 'from_dict') else d["mtPrevPage"]
                if "mtRequestId" in d:
                    v["mtRequestId"] = str.from_dict(d["mtRequestId"]) if hasattr(str, 'from_dict') else d["mtRequestId"]
                if "mtTopic" in d:
                    v["mtTopic"] = str.from_dict(d["mtTopic"]) if hasattr(str, 'from_dict') else d["mtTopic"]
                if "currency" in d:
                    v["currency"] = str.from_dict(d["currency"]) if hasattr(str, 'from_dict') else d["currency"]
                if "exchangeRateToUSD" in d:
                    v["exchangeRateToUSD"] = float.from_dict(d["exchangeRateToUSD"]) if hasattr(float, 'from_dict') else d["exchangeRateToUSD"]
                if "commerceEvent_purchase_priceType" in d:
                    v["commerceEvent_purchase_priceType"] = str.from_dict(d["commerceEvent_purchase_priceType"]) if hasattr(str, 'from_dict') else d["commerceEvent_purchase_priceType"]
                if "commerceEvent_storeFrontId" in d:
                    v["commerceEvent_storeFrontId"] = str.from_dict(d["commerceEvent_storeFrontId"]) if hasattr(str, 'from_dict') else d["commerceEvent_storeFrontId"]
                if "commerceEvent_result_resultType" in d:
                    v["commerceEvent_result_resultType"] = int.from_dict(d["commerceEvent_result_resultType"]) if hasattr(int, 'from_dict') else d["commerceEvent_result_resultType"]
                if "commerceEvent_flowType" in d:
                    v["commerceEvent_flowType"] = int.from_dict(d["commerceEvent_flowType"]) if hasattr(int, 'from_dict') else d["commerceEvent_flowType"]
                if "commerceEvent_flowStep" in d:
                    v["commerceEvent_flowStep"] = int.from_dict(d["commerceEvent_flowStep"]) if hasattr(int, 'from_dict') else d["commerceEvent_flowStep"]
                if "dialogId" in d:
                    v["dialogId"] = str.from_dict(d["dialogId"]) if hasattr(str, 'from_dict') else d["dialogId"]
                if "message" in d:
                    v["message"] = str.from_dict(d["message"]) if hasattr(str, 'from_dict') else d["message"]
                if "messageCode" in d:
                    v["messageCode"] = str.from_dict(d["messageCode"]) if hasattr(str, 'from_dict') else d["messageCode"]
                if "options" in d:
                    v["options"] = [str.from_dict(p) if hasattr(str, 'from_dict') else p for p in d["options"]]
                if "actionUrl" in d:
                    v["actionUrl"] = str.from_dict(d["actionUrl"]) if hasattr(str, 'from_dict') else d["actionUrl"]
                if "asnState" in d:
                    v["asnState"] = int.from_dict(d["asnState"]) if hasattr(int, 'from_dict') else d["asnState"]
                if "eventType" in d:
                    v["eventType"] = str.from_dict(d["eventType"]) if hasattr(str, 'from_dict') else d["eventType"]
            ...
            def as_dict(self):
                ...
                if self.__itemIds is not None:
                    d['itemIds'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__itemIds]
                ...
                if self.__priceType is not None:
                    d['priceType'] = self.__priceType.as_dict() if hasattr(self.__priceType, 'as_dict') else self.__priceType
                if self.__productTypes is not None:
                    d['productTypes'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__productTypes]
                if self.__mtApp is not None:
                    d['mtApp'] = self.__mtApp.as_dict() if hasattr(self.__mtApp, 'as_dict') else self.__mtApp
                if self.__mtClientId is not None:
                    d['mtClientId'] = self.__mtClientId.as_dict() if hasattr(self.__mtClientId, 'as_dict') else self.__mtClientId
                if self.__mtEventTime is not None:
                    d['mtEventTime'] = self.__mtEventTime.as_dict() if hasattr(self.__mtEventTime, 'as_dict') else self.__mtEventTime
                if self.__mtPageId is not None:
                    d['mtPageId'] = self.__mtPageId.as_dict() if hasattr(self.__mtPageId, 'as_dict') else self.__mtPageId
                if self.__mtPageType is not None:
                    d['mtPageType'] = self.__mtPageType.as_dict() if hasattr(self.__mtPageType, 'as_dict') else self.__mtPageType
                if self.__mtPrevPage is not None:
                    d['mtPrevPage'] = self.__mtPrevPage.as_dict() if hasattr(self.__mtPrevPage, 'as_dict') else self.__mtPrevPage
                if self.__mtRequestId is not None:
                    d['mtRequestId'] = self.__mtRequestId.as_dict() if hasattr(self.__mtRequestId, 'as_dict') else self.__mtRequestId
                if self.__mtTopic is not None:
                    d['mtTopic'] = self.__mtTopic.as_dict() if hasattr(self.__mtTopic, 'as_dict') else self.__mtTopic
                if self.__currency is not None:
                    d['currency'] = self.__currency.as_dict() if hasattr(self.__currency, 'as_dict') else self.__currency
                if self.__exchangeRateToUSD is not None:
                    d['exchangeRateToUSD'] = self.__exchangeRateToUSD.as_dict() if hasattr(self.__exchangeRateToUSD, 'as_dict') else self.__exchangeRateToUSD
                if self.__commerceEvent_purchase_priceType is not None:
                    d['commerceEvent_purchase_priceType'] = self.__commerceEvent_purchase_priceType.as_dict() if hasattr(self.__commerceEvent_purchase_priceType, 'as_dict') else self.__commerceEvent_purchase_priceType
                if self.__commerceEvent_storeFrontId is not None:
                    d['commerceEvent_storeFrontId'] = self.__commerceEvent_storeFrontId.as_dict() if hasattr(self.__commerceEvent_storeFrontId, 'as_dict') else self.__commerceEvent_storeFrontId
                if self.__commerceEvent_result_resultType is not None:
                    d['commerceEvent_result_resultType'] = self.__commerceEvent_result_resultType.as_dict() if hasattr(self.__commerceEvent_result_resultType, 'as_dict') else self.__commerceEvent_result_resultType
                if self.__commerceEvent_flowType is not None:
                    d['commerceEvent_flowType'] = self.__commerceEvent_flowType.as_dict() if hasattr(self.__commerceEvent_flowType, 'as_dict') else self.__commerceEvent_flowType
                if self.__commerceEvent_flowStep is not None:
                    d['commerceEvent_flowStep'] = self.__commerceEvent_flowStep.as_dict() if hasattr(self.__commerceEvent_flowStep, 'as_dict') else self.__commerceEvent_flowStep
                if self.__dialogId is not None:
                    d['dialogId'] = self.__dialogId.as_dict() if hasattr(self.__dialogId, 'as_dict') else self.__dialogId
                if self.__message is not None:
                    d['message'] = self.__message.as_dict() if hasattr(self.__message, 'as_dict') else self.__message
                if self.__messageCode is not None:
                    d['messageCode'] = self.__messageCode.as_dict() if hasattr(self.__messageCode, 'as_dict') else self.__messageCode
                if self.__options is not None:
                    d['options'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__options]
                if self.__actionUrl is not None:
                    d['actionUrl'] = self.__actionUrl.as_dict() if hasattr(self.__actionUrl, 'as_dict') else self.__actionUrl
                if self.__asnState is not None:
                    d['asnState'] = self.__asnState.as_dict() if hasattr(self.__asnState, 'as_dict') else self.__asnState
                if self.__eventType is not None:
                    d['eventType'] = self.__eventType.as_dict() if hasattr(self.__eventType, 'as_dict') else self.__eventType
                return d

            def __repr__(self):
                return "<Class _metrics. itemIds: {}, price: {}, priceType: {}, productTypes: {}, mtApp: {}, mtClientId: {}, mtEventTime: {}, mtPageId: {}, mtPageType: {}, mtPrevPage: {}, mtRequestId: {}, mtTopic: {}, currency: {}, exchangeRateToUSD: {}, commerceEvent_purchase_priceType: {}, commerceEvent_storeFrontId: {}, commerceEvent_result_resultType: {}, commerceEvent_flowType: {}, commerceEvent_flowStep: {}, dialogId: {}, message: {}, messageCode: {}, options: {}, actionUrl: {}, asnState: {}, eventType: {}>".format(limitedRepr(self.__itemIds[:20] if isinstance(self.__itemIds, bytes) else self.__itemIds), limitedRepr(self.__price[:20] if isinstance(self.__price, bytes) else self.__price), limitedRepr(self.__priceType[:20] if isinstance(self.__priceType, bytes) else self.__priceType), limitedRepr(self.__productTypes[:20] if isinstance(self.__productTypes, bytes) else self.__productTypes), limitedRepr(self.__mtApp[:20] if isinstance(self.__mtApp, bytes) else self.__mtApp), limitedRepr(self.__mtClientId[:20] if isinstance(self.__mtClientId, bytes) else self.__mtClientId), limitedRepr(self.__mtEventTime[:20] if isinstance(self.__mtEventTime, bytes) else self.__mtEventTime), limitedRepr(self.__mtPageId[:20] if isinstance(self.__mtPageId, bytes) else self.__mtPageId), limitedRepr(self.__mtPageType[:20] if isinstance(self.__mtPageType, bytes) else self.__mtPageType), limitedRepr(self.__mtPrevPage[:20] if isinstance(self.__mtPrevPage, bytes) else self.__mtPrevPage), limitedRepr(self.__mtRequestId[:20] if isinstance(self.__mtRequestId, bytes) else self.__mtRequestId), limitedRepr(self.__mtTopic[:20] if isinstance(self.__mtTopic, bytes) else self.__mtTopic), limitedRepr(self.__currency[:20] if isinstance(self.__currency, bytes) else self.__currency), limitedRepr(self.__exchangeRateToUSD[:20] if isinstance(self.__exchangeRateToUSD, bytes) else self.__exchangeRateToUSD), limitedRepr(self.__commerceEvent_purchase_priceType[:20] if isinstance(self.__commerceEvent_purchase_priceType, bytes) else self.__commerceEvent_purchase_priceType), limitedRepr(self.__commerceEvent_storeFrontId[:20] if isinstance(self.__commerceEvent_storeFrontId, bytes) else self.__commerceEvent_storeFrontId), limitedRepr(self.__commerceEvent_result_resultType[:20] if isinstance(self.__commerceEvent_result_resultType, bytes) else self.__commerceEvent_result_resultType), limitedRepr(self.__commerceEvent_flowType[:20] if isinstance(self.__commerceEvent_flowType, bytes) else self.__commerceEvent_flowType), limitedRepr(self.__commerceEvent_flowStep[:20] if isinstance(self.__commerceEvent_flowStep, bytes) else self.__commerceEvent_flowStep), limitedRepr(self.__dialogId[:20] if isinstance(self.__dialogId, bytes) else self.__dialogId), limitedRepr(self.__message[:20] if isinstance(self.__message, bytes) else self.__message), limitedRepr(self.__messageCode[:20] if isinstance(self.__messageCode, bytes) else self.__messageCode), limitedRepr(self.__options[:20] if isinstance(self.__options, bytes) else self.__options), limitedRepr(self.__actionUrl[:20] if isinstance(self.__actionUrl, bytes) else self.__actionUrl), limitedRepr(self.__asnState[:20] if isinstance(self.__asnState, bytes) else self.__asnState), limitedRepr(self.__eventType[:20] if isinstance(self.__eventType, bytes) else self.__eventType))
    ...
    class _download_queue_info:
            ...
            _validations_map = {
                'download_queue_item_count': { 'required': True,},
                'dsid': { 'required': True,},
                'is_auto_download_machine': { 'required': True,},
            }

            def __init__(self
                    , download_queue_item_count: int=None            , dsid: int=None            , is_auto_download_machine: bool=None            ):
                pass
            ...
            download_queue_item_count = property(_get_download_queue_item_count, _set_download_queue_item_count)
            ...
            is_auto_download_machine = property(_get_is_auto_download_machine, _set_is_auto_download_machine)
            ...
            def from_dict(d):
                ...
                if "download-queue-item-count" in d:
                    v["download_queue_item_count"] = int.from_dict(d["download-queue-item-count"]) if hasattr(int, 'from_dict') else d["download-queue-item-count"]
                if "dsid" in d:
                    v["dsid"] = int.from_dict(d["dsid"]) if hasattr(int, 'from_dict') else d["dsid"]
                if "is-auto-download-machine" in d:
                    v["is_auto_download_machine"] = bool.from_dict(d["is-auto-download-machine"]) if hasattr(bool, 'from_dict') else d["is-auto-download-machine"]
            ...
            def as_dict(self):
                ...
                if self.__download_queue_item_count is not None:
                    d['download-queue-item-count'] = self.__download_queue_item_count.as_dict() if hasattr(self.__download_queue_item_count, 'as_dict') else self.__download_queue_item_count
                if self.__dsid is not None:
                    d['dsid'] = self.__dsid.as_dict() if hasattr(self.__dsid, 'as_dict') else self.__dsid
                if self.__is_auto_download_machine is not None:
                    d['is-auto-download-machine'] = self.__is_auto_download_machine.as_dict() if hasattr(self.__is_auto_download_machine, 'as_dict') else self.__is_auto_download_machine
                return d

            def __repr__(self):
                return "<Class _download_queue_info. download_queue_item_count: {}, dsid: {}, is_auto_download_machine: {}>".format(limitedRepr(self.__download_queue_item_count[:20] if isinstance(self.__download_queue_item_count, bytes) else self.__download_queue_item_count), limitedRepr(self.__dsid[:20] if isinstance(self.__dsid, bytes) else self.__dsid), limitedRepr(self.__is_auto_download_machine[:20] if isinstance(self.__is_auto_download_machine, bytes) else self.__is_auto_download_machine))
    ...
    class _subscriptionStatus:
            class _terms:
                    ...
                    _validations_map = {
                        'type': { 'required': True,},
                        'latestTerms': { 'required': True,},
                        'agreedToTerms': { 'required': True,},
                        'source': { 'required': True,},
                    }

                    def __init__(self
                            , type: str=None            , latestTerms: int=None            , agreedToTerms: int=None            , source: str=None            ):
                        pass
                        self.__type = type
                    ...
                    def from_dict(d):
                        ...
                        if "latestTerms" in d:
                            v["latestTerms"] = int.from_dict(d["latestTerms"]) if hasattr(int, 'from_dict') else d["latestTerms"]
                        if "agreedToTerms" in d:
                            v["agreedToTerms"] = int.from_dict(d["agreedToTerms"]) if hasattr(int, 'from_dict') else d["agreedToTerms"]
                        if "source" in d:
                    ...
                    def as_dict(self):
                        ...
                        if self.__latestTerms is not None:
                            d['latestTerms'] = self.__latestTerms.as_dict() if hasattr(self.__latestTerms, 'as_dict') else self.__latestTerms
                        if self.__agreedToTerms is not None:
                            d['agreedToTerms'] = self.__agreedToTerms.as_dict() if hasattr(self.__agreedToTerms, 'as_dict') else self.__agreedToTerms
                        if self.__source is not None:
                            d['source'] = self.__source.as_dict() if hasattr(self.__source, 'as_dict') else self.__source
                        return d

                    def __repr__(self):
                        return "<Class _terms. type: {}, latestTerms: {}, agreedToTerms: {}, source: {}>".format(limitedRepr(self.__type[:20] if isinstance(self.__type, bytes) else self.__type), limitedRepr(self.__latestTerms[:20] if isinstance(self.__latestTerms, bytes) else self.__latestTerms), limitedRepr(self.__agreedToTerms[:20] if isinstance(self.__agreedToTerms, bytes) else self.__agreedToTerms), limitedRepr(self.__source[:20] if isinstance(self.__source, bytes) else self.__source))
            ...
            class _family:
                    ...
                    def from_dict(d):
                        v = {}
                        if "hasFamily" in d:
                            v["hasFamily"] = bool.from_dict(d["hasFamily"]) if hasattr(bool, 'from_dict') else d["hasFamily"]
                    ...
                    def as_dict(self):
                        ...
                        if self.__hasFamily is not None:
                            d['hasFamily'] = self.__hasFamily.as_dict() if hasattr(self.__hasFamily, 'as_dict') else self.__hasFamily
                        return d

                    def __repr__(self):
                        return "<Class _family. hasFamily: {}>".format(limitedRepr(self.__hasFamily[:20] if isinstance(self.__hasFamily, bytes) else self.__hasFamily))
            ...
            class _account:
                    ...
                    _validations_map = {
                        'isMinor': { 'required': True,},
                        'suspectUnderage': { 'required': True,},
                    }

                    def __init__(self
                            , isMinor: bool=None            , suspectUnderage: bool=None            ):
                        pass
                    ...
                    def from_dict(d):
                        v = {}
                        if "isMinor" in d:
                            v["isMinor"] = bool.from_dict(d["isMinor"]) if hasattr(bool, 'from_dict') else d["isMinor"]
                        if "suspectUnderage" in d:
                            v["suspectUnderage"] = bool.from_dict(d["suspectUnderage"]) if hasattr(bool, 'from_dict') else d["suspectUnderage"]
                    ...
                    def as_dict(self):
                        ...
                        if self.__isMinor is not None:
                            d['isMinor'] = self.__isMinor.as_dict() if hasattr(self.__isMinor, 'as_dict') else self.__isMinor
                        if self.__suspectUnderage is not None:
                            d['suspectUnderage'] = self.__suspectUnderage.as_dict() if hasattr(self.__suspectUnderage, 'as_dict') else self.__suspectUnderage
                        return d

                    def __repr__(self):
                        return "<Class _account. isMinor: {}, suspectUnderage: {}>".format(limitedRepr(self.__isMinor[:20] if isinstance(self.__isMinor, bytes) else self.__isMinor), limitedRepr(self.__suspectUnderage[:20] if isinstance(self.__suspectUnderage, bytes) else self.__suspectUnderage))
            ...
            class _music:
                    ...
                    _validations_map = {
                        ...
                        'isNotEligibleForFreeTrial': { 'required': True,},
                    }

                    def __init__(self
                            , status: str=None            , reason: str=None            , isAdmin: bool=None            , isNotEligibleForFreeTrial: bool=None            ):
                        pass
                    ...
                    isNotEligibleForFreeTrial = property(_get_isNotEligibleForFreeTrial, _set_isNotEligibleForFreeTrial)
                    ...
                    def from_dict(d):
                        ...
                        if "reason" in d:
                            v["reason"] = str.from_dict(d["reason"]) if hasattr(str, 'from_dict') else d["reason"]
                        if "isAdmin" in d:
                            v["isAdmin"] = bool.from_dict(d["isAdmin"]) if hasattr(bool, 'from_dict') else d["isAdmin"]
                        if "isNotEligibleForFreeTrial" in d:
                            v["isNotEligibleForFreeTrial"] = bool.from_dict(d["isNotEligibleForFreeTrial"]) if hasattr(bool, 'from_dict') else d["isNotEligibleForFreeTrial"]
                    ...
                    def as_dict(self):
                        ...
                        if self.__reason is not None:
                            d['reason'] = self.__reason.as_dict() if hasattr(self.__reason, 'as_dict') else self.__reason
                        if self.__isAdmin is not None:
                            d['isAdmin'] = self.__isAdmin.as_dict() if hasattr(self.__isAdmin, 'as_dict') else self.__isAdmin
                        if self.__isNotEligibleForFreeTrial is not None:
                            d['isNotEligibleForFreeTrial'] = self.__isNotEligibleForFreeTrial.as_dict() if hasattr(self.__isNotEligibleForFreeTrial, 'as_dict') else self.__isNotEligibleForFreeTrial
                        return d

                    def __repr__(self):
                        return "<Class _music. status: {}, reason: {}, isAdmin: {}, isNotEligibleForFreeTrial: {}>".format(limitedRepr(self.__status[:20] if isinstance(self.__status, bytes) else self.__status), limitedRepr(self.__reason[:20] if isinstance(self.__reason, bytes) else self.__reason), limitedRepr(self.__isAdmin[:20] if isinstance(self.__isAdmin, bytes) else self.__isAdmin), limitedRepr(self.__isNotEligibleForFreeTrial[:20] if isinstance(self.__isNotEligibleForFreeTrial, bytes) else self.__isNotEligibleForFreeTrial))
            ...
            def __init__(self
                    , music: _music=None            , terms: List[_terms]
        =None            , account: _account=None            , family: _family=None            ):
                pass
                self.__music = music
                self.__terms = terms
            ...
            def _set_music(self, value):
                if  not isinstance(value, StoreBuyproductResp._subscriptionStatus._music):
                    raise TypeError("music must be StoreBuyproductResp._subscriptionStatus._music")
            ...
            def _set_terms(self, value):
                ...
                if  not all(isinstance(i, StoreBuyproductResp._subscriptionStatus._terms) for i in value):
                    raise TypeError("terms list values must be StoreBuyproductResp._subscriptionStatus._terms")
            ...
            def _set_account(self, value):
                if  not isinstance(value, StoreBuyproductResp._subscriptionStatus._account):
                    raise TypeError("account must be StoreBuyproductResp._subscriptionStatus._account")
            ...
            def _set_family(self, value):
                if  not isinstance(value, StoreBuyproductResp._subscriptionStatus._family):
                    raise TypeError("family must be StoreBuyproductResp._subscriptionStatus._family")
            ...
            def from_dict(d):
                v = {}
                if "music" in d:
                    v["music"] = StoreBuyproductResp._subscriptionStatus._music.from_dict(d["music"]) if hasattr(StoreBuyproductResp._subscriptionStatus._music, 'from_dict') else d["music"]
                if "terms" in d:
                    v["terms"] = [StoreBuyproductResp._subscriptionStatus._terms.from_dict(p) if hasattr(StoreBuyproductResp._subscriptionStatus._terms, 'from_dict') else p for p in d["terms"]]
                if "account" in d:
                    v["account"] = StoreBuyproductResp._subscriptionStatus._account.from_dict(d["account"]) if hasattr(StoreBuyproductResp._subscriptionStatus._account, 'from_dict') else d["account"]
                if "family" in d:
                    v["family"] = StoreBuyproductResp._subscriptionStatus._family.from_dict(d["family"]) if hasattr(StoreBuyproductResp._subscriptionStatus._family, 'from_dict') else d["family"]
            ...
            def as_dict(self):
                ...
                if self.__music is not None:
                    d['music'] = self.__music.as_dict() if hasattr(self.__music, 'as_dict') else self.__music
                if self.__terms is not None:
                    d['terms'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__terms]
                if self.__account is not None:
                    d['account'] = self.__account.as_dict() if hasattr(self.__account, 'as_dict') else self.__account
                if self.__family is not None:
                    d['family'] = self.__family.as_dict() if hasattr(self.__family, 'as_dict') else self.__family
                return d

            def __repr__(self):
                return "<Class _subscriptionStatus. music: {}, terms: {}, account: {}, family: {}>".format(limitedRepr(self.__music[:20] if isinstance(self.__music, bytes) else self.__music), limitedRepr(self.__terms[:20] if isinstance(self.__terms, bytes) else self.__terms), limitedRepr(self.__account[:20] if isinstance(self.__account, bytes) else self.__account), limitedRepr(self.__family[:20] if isinstance(self.__family, bytes) else self.__family))
    ...
    class _songList:
            class _asset_info:
                    ...
                    def __init__(self
                            , file_size: int=None            , flavor: str=None            ):
                        pass
                    ...
                    def from_dict(d):
                        v = {}
                        if "file-size" in d:
                            v["file_size"] = int.from_dict(d["file-size"]) if hasattr(int, 'from_dict') else d["file-size"]
                        if "flavor" in d:
                            v["flavor"] = str.from_dict(d["flavor"]) if hasattr(str, 'from_dict') else d["flavor"]
                    ...
                    def as_dict(self):
                        ...
                        if self.__file_size is not None:
                            d['file-size'] = self.__file_size.as_dict() if hasattr(self.__file_size, 'as_dict') else self.__file_size
                        if self.__flavor is not None:
                            d['flavor'] = self.__flavor.as_dict() if hasattr(self.__flavor, 'as_dict') else self.__flavor
                        return d

                    def __repr__(self):
                        return "<Class _asset_info. file_size: {}, flavor: {}>".format(limitedRepr(self.__file_size[:20] if isinstance(self.__file_size, bytes) else self.__file_size), limitedRepr(self.__flavor[:20] if isinstance(self.__flavor, bytes) else self.__flavor))
            ...
            class _chunks:
                    ...
                    _validations_map = {
                        'chunkSize': { 'required': True,},
                        'hashes': { 'required': True,},
                    }

                    def __init__(self
                            , chunkSize: int=None            , hashes: List[str]
                =None            ):
                        pass
                    ...
                    def from_dict(d):
                        v = {}
                        if "chunkSize" in d:
                            v["chunkSize"] = int.from_dict(d["chunkSize"]) if hasattr(int, 'from_dict') else d["chunkSize"]
                        if "hashes" in d:
                            v["hashes"] = [str.from_dict(p) if hasattr(str, 'from_dict') else p for p in d["hashes"]]
                    ...
                    def as_dict(self):
                        ...
                        if self.__chunkSize is not None:
                            d['chunkSize'] = self.__chunkSize.as_dict() if hasattr(self.__chunkSize, 'as_dict') else self.__chunkSize
                        if self.__hashes is not None:
                            d['hashes'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__hashes]
                        return d

                    def __repr__(self):
                        return "<Class _chunks. chunkSize: {}, hashes: {}>".format(limitedRepr(self.__chunkSize[:20] if isinstance(self.__chunkSize, bytes) else self.__chunkSize), limitedRepr(self.__hashes[:20] if isinstance(self.__hashes, bytes) else self.__hashes))
            ...
            class _artwork_urls:
                    class _default:
                            ...
                            def __repr__(self):
                                return "<Class _default. url: {}>".format(limitedRepr(self.__url[:20] if isinstance(self.__url, bytes) else self.__url))
                    ...
                    def __init__(self
                            , image_type: str=None            , default: _default=None            ):
                        pass
                    ...
                    def _set_default(self, value):
                        if  not isinstance(value, StoreBuyproductResp._songList._artwork_urls._default):
                            raise TypeError("default must be StoreBuyproductResp._songList._artwork_urls._default")
                    ...
                    def from_dict(d):
                        v = {}
                        if "image-type" in d:
                            v["image_type"] = str.from_dict(d["image-type"]) if hasattr(str, 'from_dict') else d["image-type"]
                        if "default" in d:
                            v["default"] = StoreBuyproductResp._songList._artwork_urls._default.from_dict(d["default"]) if hasattr(StoreBuyproductResp._songList._artwork_urls._default, 'from_dict') else d["default"]
                    ...
                    def as_dict(self):
                        ...
                        if self.__image_type is not None:
                            d['image-type'] = self.__image_type.as_dict() if hasattr(self.__image_type, 'as_dict') else self.__image_type
                        if self.__default is not None:
                            d['default'] = self.__default.as_dict() if hasattr(self.__default, 'as_dict') else self.__default
                        return d

                    def __repr__(self):
                        return "<Class _artwork_urls. image_type: {}, default: {}>".format(limitedRepr(self.__image_type[:20] if isinstance(self.__image_type, bytes) else self.__image_type), limitedRepr(self.__default[:20] if isinstance(self.__default, bytes) else self.__default))
            ...
            class _sinfs:
                    ...
                    def from_dict(d):
                        ...
                        if "sinf" in d:
                            v["sinf"] = str.from_dict(d["sinf"]) if hasattr(str, 'from_dict') else d["sinf"]
                    ...
                    def as_dict(self):
                        ...
                        if self.__sinf is not None:
                            d['sinf'] = self.__sinf.as_dict() if hasattr(self.__sinf, 'as_dict') else self.__sinf
                        return d

                    def __repr__(self):
                        return "<Class _sinfs. id: {}, sinf: {}>".format(limitedRepr(self.__id[:20] if isinstance(self.__id, bytes) else self.__id), limitedRepr(self.__sinf[:20] if isinstance(self.__sinf, bytes) else self.__sinf))
            ...
            class _metadata:
                    class _UIRequiredDeviceCapabilities:
                            ...
                            def from_dict(d):
                                v = {}
                                if "arm64" in d:
                                    v["arm64"] = bool.from_dict(d["arm64"]) if hasattr(bool, 'from_dict') else d["arm64"]
                                return StoreBuyproductResp._songList._metadata._UIRequiredDeviceCapabilities(**v)


                            def as_dict(self):
                                d = {}
                                if self.__arm64 is not None:
                                    d['arm64'] = self.__arm64.as_dict() if hasattr(self.__arm64, 'as_dict') else self.__arm64
                                return d

                            def __repr__(self):
                                return "<Class _UIRequiredDeviceCapabilities. arm64: {}>".format(limitedRepr(self.__arm64[:20] if isinstance(self.__arm64, bytes) else self.__arm64))
                    ...
                    class _MacUIRequiredDeviceCapabilities:
                            ...
                            def from_dict(d):
                                ...
                                if "arm64" in d:
                                    v["arm64"] = bool.from_dict(d["arm64"]) if hasattr(bool, 'from_dict') else d["arm64"]
                                return StoreBuyproductResp._songList._metadata._MacUIRequiredDeviceCapabilities(**v)
                            ...
                            def __repr__(self):
                                return "<Class _MacUIRequiredDeviceCapabilities. arm64: {}>".format(limitedRepr(self.__arm64[:20] if isinstance(self.__arm64, bytes) else self.__arm64))
                    ...
                    class _rating:
                            ...
                            def __init__(self
                                    , content: str=None            , label: str=None            , rank: int=None            , system: str=None            ):
                                pass
                            ...
                            def from_dict(d):
                                v = {}
                                if "content" in d:
                                    v["content"] = str.from_dict(d["content"]) if hasattr(str, 'from_dict') else d["content"]
                                if "label" in d:
                                    v["label"] = str.from_dict(d["label"]) if hasattr(str, 'from_dict') else d["label"]
                                if "rank" in d:
                                    v["rank"] = int.from_dict(d["rank"]) if hasattr(int, 'from_dict') else d["rank"]
                                if "system" in d:
                                    v["system"] = str.from_dict(d["system"]) if hasattr(str, 'from_dict') else d["system"]
                            ...
                            def as_dict(self):
                                ...
                                if self.__content is not None:
                                    d['content'] = self.__content.as_dict() if hasattr(self.__content, 'as_dict') else self.__content
                                if self.__label is not None:
                                    d['label'] = self.__label.as_dict() if hasattr(self.__label, 'as_dict') else self.__label
                                if self.__rank is not None:
                                    d['rank'] = self.__rank.as_dict() if hasattr(self.__rank, 'as_dict') else self.__rank
                                if self.__system is not None:
                                    d['system'] = self.__system.as_dict() if hasattr(self.__system, 'as_dict') else self.__system
                                return d

                            def __repr__(self):
                                return "<Class _rating. content: {}, label: {}, rank: {}, system: {}>".format(limitedRepr(self.__content[:20] if isinstance(self.__content, bytes) else self.__content), limitedRepr(self.__label[:20] if isinstance(self.__label, bytes) else self.__label), limitedRepr(self.__rank[:20] if isinstance(self.__rank, bytes) else self.__rank), limitedRepr(self.__system[:20] if isinstance(self.__system, bytes) else self.__system))
                    ...
                    class _nameTranscriptions:
                        ...
                        =None            ):
                            ...
                            def from_dict(d):
                                v = {}
                                if "zh-Hans-CN" in d:
                                    v["zh_Hans_CN"] = [str.from_dict(p) if hasattr(str, 'from_dict') else p for p in d["zh-Hans-CN"]]
                                return StoreBuyproductResp._songList._metadata._nameTranscriptions(**v)


                            def as_dict(self):
                                d = {}
                                if self.__zh_Hans_CN is not None:
                                    d['zh-Hans-CN'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__zh_Hans_CN]
                                return d

                            def __repr__(self):
                                return "<Class _nameTranscriptions. zh_Hans_CN: {}>".format(limitedRepr(self.__zh_Hans_CN[:20] if isinstance(self.__zh_Hans_CN, bytes) else self.__zh_Hans_CN))




                    _types_map = {
                        'MacUIRequiredDeviceCapabilities': {'type': _MacUIRequiredDeviceCapabilities, 'subtype': None},
                        'UIRequiredDeviceCapabilities': {'type': _UIRequiredDeviceCapabilities, 'subtype': None},
                    ...
                    _validations_map = {
                        'MacUIRequiredDeviceCapabilities': { 'required': True,},
                        'UIRequiredDeviceCapabilities': { 'required': True,},
                        'WKRunsIndependentlyOfCompanionApp': { 'required': True,},
                        'WKWatchOnly': { 'required': True,},
                        'appleWatchEnabled': { 'required': True,},
                        'artistId': { 'required': True,},
                        'artistName': { 'required': True,},
                        'bundleDisplayName': { 'required': True,},
                        'bundleShortVersionString': { 'required': True,},
                        'bundleVersion': { 'required': True,},
                        'copyright': { 'required': True,},
                        'fileExtension': { 'required': True,},
                        'gameCenterEnabled': { 'required': True,},
                        'gameCenterEverEnabled': { 'required': True,},
                        'genre': { 'required': True,},
                        'genreId': { 'required': True,},
                        'itemId': { 'required': True,},
                        'itemName': { 'required': True,},
                        'kind': { 'required': True,},
                        'nameTranscriptions': { 'required': True,},
                        'playlistName': { 'required': True,},
                        'product_type': { 'required': True,},
                        'rating': { 'required': True,},
                        'releaseDate': { 'required': True,},
                        'requiresRosetta': { 'required': True,},
                        'runsOnAppleSilicon': { 'required': True,},
                        'runsOnIntel': { 'required': True,},
                        's': { 'required': True,},
                        'software_platform': { 'required': True,},
                        'softwareIcon57x57URL': { 'required': True,},
                        'softwareIconNeedsShine': { 'required': True,},
                        'softwareSupportedDeviceIds': { 'required': True,},
                        'softwareVersionBundleId': { 'required': True,},
                        'softwareVersionExternalIdentifier': { 'required': True,},
                        'softwareVersionExternalIdentifiers': { 'required': True,},
                        'vendorId': { 'required': True,},
                        'drmVersionNumber': { 'required': True,},
                        'versionRestrictions': { 'required': True,},
                        'storeCohort': { 'required': True,},
                        'hasOrEverHasHadIAP': { 'required': True,},
                    }

                    def __init__(self
                            , MacUIRequiredDeviceCapabilities: _MacUIRequiredDeviceCapabilities=None            , UIRequiredDeviceCapabilities: _UIRequiredDeviceCapabilities=None            , WKRunsIndependentlyOfCompanionApp: bool=None            , WKWatchOnly: bool=None            , appleWatchEnabled: bool=None            , artistId: int=None            , artistName: str=None            , bundleDisplayName: str=None            , bundleShortVersionString: str=None            , bundleVersion: str=None            , copyright: str=None            , fileExtension: str=None            , gameCenterEnabled: bool=None            , gameCenterEverEnabled: bool=None            , genre: str=None            , genreId: int=None            , itemId: int=None            , itemName: str=None            , kind: str=None            , nameTranscriptions: _nameTranscriptions=None            , playlistName: str=None            , product_type: str=None            , rating: _rating=None            , releaseDate: str=None            , requiresRosetta: bool=None            , runsOnAppleSilicon: bool=None            , runsOnIntel: bool=None            , s: int=None            , software_platform: str=None            , softwareIcon57x57URL: str=None            , softwareIconNeedsShine: bool=None            , softwareSupportedDeviceIds: List[int]
                =None            , softwareVersionBundleId: str=None            , softwareVersionExternalIdentifier: int=None            , softwareVersionExternalIdentifiers: List[int]
                =None            , vendorId: int=None            , drmVersionNumber: int=None            , versionRestrictions: int=None            , storeCohort: str=None            , hasOrEverHasHadIAP: bool=None            ):
                        pass
                        ...
                        self.__WKRunsIndependentlyOfCompanionApp = WKRunsIndependentlyOfCompanionApp
                        ...
                        self.__softwareVersionExternalIdentifier = softwareVersionExternalIdentifier
                        self.__softwareVersionExternalIdentifiers = softwareVersionExternalIdentifiers
                    ...
                    def _set_MacUIRequiredDeviceCapabilities(self, value):
                        if  not isinstance(value, StoreBuyproductResp._songList._metadata._MacUIRequiredDeviceCapabilities):
                            raise TypeError("MacUIRequiredDeviceCapabilities must be StoreBuyproductResp._songList._metadata._MacUIRequiredDeviceCapabilities")

                        self.__MacUIRequiredDeviceCapabilities = value
                    MacUIRequiredDeviceCapabilities = property(_get_MacUIRequiredDeviceCapabilities, _set_MacUIRequiredDeviceCapabilities)
                    ...
                    def _set_UIRequiredDeviceCapabilities(self, value):
                        if  not isinstance(value, StoreBuyproductResp._songList._metadata._UIRequiredDeviceCapabilities):
                            raise TypeError("UIRequiredDeviceCapabilities must be StoreBuyproductResp._songList._metadata._UIRequiredDeviceCapabilities")

                        self.__UIRequiredDeviceCapabilities = value
                    UIRequiredDeviceCapabilities = property(_get_UIRequiredDeviceCapabilities, _set_UIRequiredDeviceCapabilities)
                    ...
                    WKRunsIndependentlyOfCompanionApp = property(_get_WKRunsIndependentlyOfCompanionApp, _set_WKRunsIndependentlyOfCompanionApp)
                    ...
                    bundleShortVersionString = property(_get_bundleShortVersionString, _set_bundleShortVersionString)
                    ...
                    gameCenterEverEnabled = property(_get_gameCenterEverEnabled, _set_gameCenterEverEnabled)
                    ...
                    def _set_nameTranscriptions(self, value):
                        if  not isinstance(value, StoreBuyproductResp._songList._metadata._nameTranscriptions):
                            raise TypeError("nameTranscriptions must be StoreBuyproductResp._songList._metadata._nameTranscriptions")

                        self.__nameTranscriptions = value
                    nameTranscriptions = property(_get_nameTranscriptions, _set_nameTranscriptions)
                    ...
                    def _set_rating(self, value):
                        if  not isinstance(value, StoreBuyproductResp._songList._metadata._rating):
                            raise TypeError("rating must be StoreBuyproductResp._songList._metadata._rating")
                    ...
                    runsOnAppleSilicon = property(_get_runsOnAppleSilicon, _set_runsOnAppleSilicon)
                    ...
                    softwareIcon57x57URL = property(_get_softwareIcon57x57URL, _set_softwareIcon57x57URL)
                    ...
                    softwareIconNeedsShine = property(_get_softwareIconNeedsShine, _set_softwareIconNeedsShine)
                    ...
                    def _set_softwareSupportedDeviceIds(self, value):
                        ...
                        if  not all(isinstance(i, int) for i in value):
                            raise TypeError("softwareSupportedDeviceIds list values must be int")

                        self.__softwareSupportedDeviceIds = value
                    softwareSupportedDeviceIds = property(_get_softwareSupportedDeviceIds, _set_softwareSupportedDeviceIds)
                    ...
                    softwareVersionBundleId = property(_get_softwareVersionBundleId, _set_softwareVersionBundleId)
                    ...
                    softwareVersionExternalIdentifier = property(_get_softwareVersionExternalIdentifier, _set_softwareVersionExternalIdentifier)
                    ...
                    def _set_softwareVersionExternalIdentifiers(self, value):
                        ...
                        if  not all(isinstance(i, int) for i in value):
                            raise TypeError("softwareVersionExternalIdentifiers list values must be int")

                        self.__softwareVersionExternalIdentifiers = value
                    softwareVersionExternalIdentifiers = property(_get_softwareVersionExternalIdentifiers, _set_softwareVersionExternalIdentifiers)
                    ...
                    versionRestrictions = property(_get_versionRestrictions, _set_versionRestrictions)
                    ...
                    hasOrEverHasHadIAP = property(_get_hasOrEverHasHadIAP, _set_hasOrEverHasHadIAP)
                    ...
                    def from_dict(d):
                        ...
                        if "MacUIRequiredDeviceCapabilities" in d:
                            v["MacUIRequiredDeviceCapabilities"] = StoreBuyproductResp._songList._metadata._MacUIRequiredDeviceCapabilities.from_dict(d["MacUIRequiredDeviceCapabilities"]) if hasattr(StoreBuyproductResp._songList._metadata._MacUIRequiredDeviceCapabilities, 'from_dict') else d["MacUIRequiredDeviceCapabilities"]
                        if "UIRequiredDeviceCapabilities" in d:
                            v["UIRequiredDeviceCapabilities"] = StoreBuyproductResp._songList._metadata._UIRequiredDeviceCapabilities.from_dict(d["UIRequiredDeviceCapabilities"]) if hasattr(StoreBuyproductResp._songList._metadata._UIRequiredDeviceCapabilities, 'from_dict') else d["UIRequiredDeviceCapabilities"]
                        if "WKRunsIndependentlyOfCompanionApp" in d:
                            v["WKRunsIndependentlyOfCompanionApp"] = bool.from_dict(d["WKRunsIndependentlyOfCompanionApp"]) if hasattr(bool, 'from_dict') else d["WKRunsIndependentlyOfCompanionApp"]
                        if "WKWatchOnly" in d:
                            v["WKWatchOnly"] = bool.from_dict(d["WKWatchOnly"]) if hasattr(bool, 'from_dict') else d["WKWatchOnly"]
                        if "appleWatchEnabled" in d:
                            v["appleWatchEnabled"] = bool.from_dict(d["appleWatchEnabled"]) if hasattr(bool, 'from_dict') else d["appleWatchEnabled"]
                        if "artistId" in d:
                            v["artistId"] = int.from_dict(d["artistId"]) if hasattr(int, 'from_dict') else d["artistId"]
                        if "artistName" in d:
                            v["artistName"] = str.from_dict(d["artistName"]) if hasattr(str, 'from_dict') else d["artistName"]
                        if "bundleDisplayName" in d:
                            v["bundleDisplayName"] = str.from_dict(d["bundleDisplayName"]) if hasattr(str, 'from_dict') else d["bundleDisplayName"]
                        if "bundleShortVersionString" in d:
                            v["bundleShortVersionString"] = str.from_dict(d["bundleShortVersionString"]) if hasattr(str, 'from_dict') else d["bundleShortVersionString"]
                        if "bundleVersion" in d:
                            v["bundleVersion"] = str.from_dict(d["bundleVersion"]) if hasattr(str, 'from_dict') else d["bundleVersion"]
                        if "copyright" in d:
                            v["copyright"] = str.from_dict(d["copyright"]) if hasattr(str, 'from_dict') else d["copyright"]
                        if "fileExtension" in d:
                            v["fileExtension"] = str.from_dict(d["fileExtension"]) if hasattr(str, 'from_dict') else d["fileExtension"]
                        if "gameCenterEnabled" in d:
                            v["gameCenterEnabled"] = bool.from_dict(d["gameCenterEnabled"]) if hasattr(bool, 'from_dict') else d["gameCenterEnabled"]
                        if "gameCenterEverEnabled" in d:
                            v["gameCenterEverEnabled"] = bool.from_dict(d["gameCenterEverEnabled"]) if hasattr(bool, 'from_dict') else d["gameCenterEverEnabled"]
                        if "genre" in d:
                            v["genre"] = str.from_dict(d["genre"]) if hasattr(str, 'from_dict') else d["genre"]
                        if "genreId" in d:
                            v["genreId"] = int.from_dict(d["genreId"]) if hasattr(int, 'from_dict') else d["genreId"]
                        if "itemId" in d:
                            v["itemId"] = int.from_dict(d["itemId"]) if hasattr(int, 'from_dict') else d["itemId"]
                        if "itemName" in d:
                            v["itemName"] = str.from_dict(d["itemName"]) if hasattr(str, 'from_dict') else d["itemName"]
                        if "kind" in d:
                            v["kind"] = str.from_dict(d["kind"]) if hasattr(str, 'from_dict') else d["kind"]
                        if "nameTranscriptions" in d:
                            v["nameTranscriptions"] = StoreBuyproductResp._songList._metadata._nameTranscriptions.from_dict(d["nameTranscriptions"]) if hasattr(StoreBuyproductResp._songList._metadata._nameTranscriptions, 'from_dict') else d["nameTranscriptions"]
                        if "playlistName" in d:
                            v["playlistName"] = str.from_dict(d["playlistName"]) if hasattr(str, 'from_dict') else d["playlistName"]
                        if "product-type" in d:
                            v["product_type"] = str.from_dict(d["product-type"]) if hasattr(str, 'from_dict') else d["product-type"]
                        if "rating" in d:
                            v["rating"] = StoreBuyproductResp._songList._metadata._rating.from_dict(d["rating"]) if hasattr(StoreBuyproductResp._songList._metadata._rating, 'from_dict') else d["rating"]
                        if "releaseDate" in d:
                            v["releaseDate"] = str.from_dict(d["releaseDate"]) if hasattr(str, 'from_dict') else d["releaseDate"]
                        if "requiresRosetta" in d:
                            v["requiresRosetta"] = bool.from_dict(d["requiresRosetta"]) if hasattr(bool, 'from_dict') else d["requiresRosetta"]
                        if "runsOnAppleSilicon" in d:
                            v["runsOnAppleSilicon"] = bool.from_dict(d["runsOnAppleSilicon"]) if hasattr(bool, 'from_dict') else d["runsOnAppleSilicon"]
                        if "runsOnIntel" in d:
                            v["runsOnIntel"] = bool.from_dict(d["runsOnIntel"]) if hasattr(bool, 'from_dict') else d["runsOnIntel"]
                        if "s" in d:
                            v["s"] = int.from_dict(d["s"]) if hasattr(int, 'from_dict') else d["s"]
                        if "software-platform" in d:
                            v["software_platform"] = str.from_dict(d["software-platform"]) if hasattr(str, 'from_dict') else d["software-platform"]
                        if "softwareIcon57x57URL" in d:
                            v["softwareIcon57x57URL"] = str.from_dict(d["softwareIcon57x57URL"]) if hasattr(str, 'from_dict') else d["softwareIcon57x57URL"]
                        if "softwareIconNeedsShine" in d:
                            v["softwareIconNeedsShine"] = bool.from_dict(d["softwareIconNeedsShine"]) if hasattr(bool, 'from_dict') else d["softwareIconNeedsShine"]
                        if "softwareSupportedDeviceIds" in d:
                            v["softwareSupportedDeviceIds"] = [int.from_dict(p) if hasattr(int, 'from_dict') else p for p in d["softwareSupportedDeviceIds"]]
                        if "softwareVersionBundleId" in d:
                            v["softwareVersionBundleId"] = str.from_dict(d["softwareVersionBundleId"]) if hasattr(str, 'from_dict') else d["softwareVersionBundleId"]
                        if "softwareVersionExternalIdentifier" in d:
                            v["softwareVersionExternalIdentifier"] = int.from_dict(d["softwareVersionExternalIdentifier"]) if hasattr(int, 'from_dict') else d["softwareVersionExternalIdentifier"]
                        if "softwareVersionExternalIdentifiers" in d:
                            v["softwareVersionExternalIdentifiers"] = [int.from_dict(p) if hasattr(int, 'from_dict') else p for p in d["softwareVersionExternalIdentifiers"]]
                        if "vendorId" in d:
                            v["vendorId"] = int.from_dict(d["vendorId"]) if hasattr(int, 'from_dict') else d["vendorId"]
                        if "drmVersionNumber" in d:
                            v["drmVersionNumber"] = int.from_dict(d["drmVersionNumber"]) if hasattr(int, 'from_dict') else d["drmVersionNumber"]
                        if "versionRestrictions" in d:
                            v["versionRestrictions"] = int.from_dict(d["versionRestrictions"]) if hasattr(int, 'from_dict') else d["versionRestrictions"]
                        if "storeCohort" in d:
                            v["storeCohort"] = str.from_dict(d["storeCohort"]) if hasattr(str, 'from_dict') else d["storeCohort"]
                        if "hasOrEverHasHadIAP" in d:
                            v["hasOrEverHasHadIAP"] = bool.from_dict(d["hasOrEverHasHadIAP"]) if hasattr(bool, 'from_dict') else d["hasOrEverHasHadIAP"]
            ...
            _validations_map = {
                ...
                'URL': { 'required': True,},
                'downloadKey': { 'required': True,},
                'artworkURL': { 'required': True,},
                'artwork_urls': { 'required': True,},
                'md5': { 'required': True,},
                'chunks': { 'required': True,},
                'isStreamable': { 'required': True,},
                'uncompressedSize': { 'required': True,},
                'sinfs': { 'required': True,},
                'purchaseDate': { 'required': True,},
                'download_id': { 'required': True,},
                'is_in_queue': { 'required': True,},
                'asset_info': { 'required': True,},
                'metadata': { 'required': True,},
            }

            def __init__(self
                    , songId: int=None            , URL: str=None            , downloadKey: str=None            , artworkURL: str=None            , artwork_urls: _artwork_urls=None            , md5: str=None            , chunks: _chunks=None            , isStreamable: bool=None            , uncompressedSize: int=None            , sinfs: List[_sinfs]
        =None            , purchaseDate: str=None            , download_id: str=None            , is_in_queue: bool=None            , asset_info: _asset_info=None            , metadata: _metadata=None            ):
                pass
            ...
            def _set_artwork_urls(self, value):
                if  not isinstance(value, StoreBuyproductResp._songList._artwork_urls):
                    raise TypeError("artwork_urls must be StoreBuyproductResp._songList._artwork_urls")
            ...
            def _set_sinfs(self, value):
                ...
                if  not all(isinstance(i, StoreBuyproductResp._songList._sinfs) for i in value):
                    raise TypeError("sinfs list values must be StoreBuyproductResp._songList._sinfs")
            ...
            def _set_asset_info(self, value):
                if  not isinstance(value, StoreBuyproductResp._songList._asset_info):
                    raise TypeError("asset_info must be StoreBuyproductResp._songList._asset_info")
            ...
            def _set_metadata(self, value):
                if  not isinstance(value, StoreBuyproductResp._songList._metadata):
                    raise TypeError("metadata must be StoreBuyproductResp._songList._metadata")
            ...
            def from_dict(d):
                v = {}
                if "songId" in d:
                    v["songId"] = int.from_dict(d["songId"]) if hasattr(int, 'from_dict') else d["songId"]
                if "URL" in d:
                    v["URL"] = str.from_dict(d["URL"]) if hasattr(str, 'from_dict') else d["URL"]
                if "downloadKey" in d:
                    v["downloadKey"] = str.from_dict(d["downloadKey"]) if hasattr(str, 'from_dict') else d["downloadKey"]
                if "artworkURL" in d:
                    v["artworkURL"] = str.from_dict(d["artworkURL"]) if hasattr(str, 'from_dict') else d["artworkURL"]
                if "artwork-urls" in d:
                    v["artwork_urls"] = StoreBuyproductResp._songList._artwork_urls.from_dict(d["artwork-urls"]) if hasattr(StoreBuyproductResp._songList._artwork_urls, 'from_dict') else d["artwork-urls"]
                if "md5" in d:
                    v["md5"] = str.from_dict(d["md5"]) if hasattr(str, 'from_dict') else d["md5"]
                if "chunks" in d:
                    v["chunks"] = StoreBuyproductResp._songList._chunks.from_dict(d["chunks"]) if hasattr(StoreBuyproductResp._songList._chunks, 'from_dict') else d["chunks"]
                if "isStreamable" in d:
                    v["isStreamable"] = bool.from_dict(d["isStreamable"]) if hasattr(bool, 'from_dict') else d["isStreamable"]
                if "uncompressedSize" in d:
                    v["uncompressedSize"] = int.from_dict(d["uncompressedSize"]) if hasattr(int, 'from_dict') else d["uncompressedSize"]
                if "sinfs" in d:
                    v["sinfs"] = [StoreBuyproductResp._songList._sinfs.from_dict(p) if hasattr(StoreBuyproductResp._songList._sinfs, 'from_dict') else p for p in d["sinfs"]]
                if "purchaseDate" in d:
                    v["purchaseDate"] = str.from_dict(d["purchaseDate"]) if hasattr(str, 'from_dict') else d["purchaseDate"]
                if "download-id" in d:
                    v["download_id"] = str.from_dict(d["download-id"]) if hasattr(str, 'from_dict') else d["download-id"]
                if "is-in-queue" in d:
                    v["is_in_queue"] = bool.from_dict(d["is-in-queue"]) if hasattr(bool, 'from_dict') else d["is-in-queue"]
                if "asset-info" in d:
                    v["asset_info"] = StoreBuyproductResp._songList._asset_info.from_dict(d["asset-info"]) if hasattr(StoreBuyproductResp._songList._asset_info, 'from_dict') else d["asset-info"]
                if "metadata" in d:
                    v["metadata"] = StoreBuyproductResp._songList._metadata.from_dict(d["metadata"]) if hasattr(StoreBuyproductResp._songList._metadata, 'from_dict') else d["metadata"]
            ...
            def as_dict(self):
                ...
                if self.__songId is not None:
                    d['songId'] = self.__songId.as_dict() if hasattr(self.__songId, 'as_dict') else self.__songId
                if self.__URL is not None:
                    d['URL'] = self.__URL.as_dict() if hasattr(self.__URL, 'as_dict') else self.__URL
                if self.__downloadKey is not None:
                    d['downloadKey'] = self.__downloadKey.as_dict() if hasattr(self.__downloadKey, 'as_dict') else self.__downloadKey
                if self.__artworkURL is not None:
                    d['artworkURL'] = self.__artworkURL.as_dict() if hasattr(self.__artworkURL, 'as_dict') else self.__artworkURL
                if self.__artwork_urls is not None:
                    d['artwork-urls'] = self.__artwork_urls.as_dict() if hasattr(self.__artwork_urls, 'as_dict') else self.__artwork_urls
                if self.__md5 is not None:
                    d['md5'] = self.__md5.as_dict() if hasattr(self.__md5, 'as_dict') else self.__md5
                if self.__chunks is not None:
                    d['chunks'] = self.__chunks.as_dict() if hasattr(self.__chunks, 'as_dict') else self.__chunks
                if self.__isStreamable is not None:
                    d['isStreamable'] = self.__isStreamable.as_dict() if hasattr(self.__isStreamable, 'as_dict') else self.__isStreamable
                if self.__uncompressedSize is not None:
                    d['uncompressedSize'] = self.__uncompressedSize.as_dict() if hasattr(self.__uncompressedSize, 'as_dict') else self.__uncompressedSize
                if self.__sinfs is not None:
                    d['sinfs'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__sinfs]
                if self.__purchaseDate is not None:
                    d['purchaseDate'] = self.__purchaseDate.as_dict() if hasattr(self.__purchaseDate, 'as_dict') else self.__purchaseDate
                if self.__download_id is not None:
                    d['download-id'] = self.__download_id.as_dict() if hasattr(self.__download_id, 'as_dict') else self.__download_id
                if self.__is_in_queue is not None:
                    d['is-in-queue'] = self.__is_in_queue.as_dict() if hasattr(self.__is_in_queue, 'as_dict') else self.__is_in_queue
                if self.__asset_info is not None:
                    d['asset-info'] = self.__asset_info.as_dict() if hasattr(self.__asset_info, 'as_dict') else self.__asset_info
                if self.__metadata is not None:
                    d['metadata'] = self.__metadata.as_dict() if hasattr(self.__metadata, 'as_dict') else self.__metadata
                return d

            def __repr__(self):
                return "<Class _songList. songId: {}, URL: {}, downloadKey: {}, artworkURL: {}, artwork_urls: {}, md5: {}, chunks: {}, isStreamable: {}, uncompressedSize: {}, sinfs: {}, purchaseDate: {}, download_id: {}, is_in_queue: {}, asset_info: {}, metadata: {}>".format(limitedRepr(self.__songId[:20] if isinstance(self.__songId, bytes) else self.__songId), limitedRepr(self.__URL[:20] if isinstance(self.__URL, bytes) else self.__URL), limitedRepr(self.__downloadKey[:20] if isinstance(self.__downloadKey, bytes) else self.__downloadKey), limitedRepr(self.__artworkURL[:20] if isinstance(self.__artworkURL, bytes) else self.__artworkURL), limitedRepr(self.__artwork_urls[:20] if isinstance(self.__artwork_urls, bytes) else self.__artwork_urls), limitedRepr(self.__md5[:20] if isinstance(self.__md5, bytes) else self.__md5), limitedRepr(self.__chunks[:20] if isinstance(self.__chunks, bytes) else self.__chunks), limitedRepr(self.__isStreamable[:20] if isinstance(self.__isStreamable, bytes) else self.__isStreamable), limitedRepr(self.__uncompressedSize[:20] if isinstance(self.__uncompressedSize, bytes) else self.__uncompressedSize), limitedRepr(self.__sinfs[:20] if isinstance(self.__sinfs, bytes) else self.__sinfs), limitedRepr(self.__purchaseDate[:20] if isinstance(self.__purchaseDate, bytes) else self.__purchaseDate), limitedRepr(self.__download_id[:20] if isinstance(self.__download_id, bytes) else self.__download_id), limitedRepr(self.__is_in_queue[:20] if isinstance(self.__is_in_queue, bytes) else self.__is_in_queue), limitedRepr(self.__asset_info[:20] if isinstance(self.__asset_info, bytes) else self.__asset_info), limitedRepr(self.__metadata[:20] if isinstance(self.__metadata, bytes) else self.__metadata))
    ...
    class _dialog:
            class _okButtonAction:
                    ...
                    _validations_map = {
                        'kind': { 'required': True,},
                        'buyParams': { 'required': True,},
                        'itemName': { 'required': True,},
                    }

                    def __init__(self
                            , kind: str=None            , buyParams: str=None            , itemName: str=None            ):
                        pass
                        self.__kind = kind
                    ...
                    def from_dict(d):
                        ...
                        if "kind" in d:
                            v["kind"] = str.from_dict(d["kind"]) if hasattr(str, 'from_dict') else d["kind"]
                        if "buyParams" in d:
                            v["buyParams"] = str.from_dict(d["buyParams"]) if hasattr(str, 'from_dict') else d["buyParams"]
                        if "itemName" in d:
                            v["itemName"] = str.from_dict(d["itemName"]) if hasattr(str, 'from_dict') else d["itemName"]
                    ...
                    def as_dict(self):
                        ...
                        if self.__buyParams is not None:
                            d['buyParams'] = self.__buyParams.as_dict() if hasattr(self.__buyParams, 'as_dict') else self.__buyParams
                        if self.__itemName is not None:
                            d['itemName'] = self.__itemName.as_dict() if hasattr(self.__itemName, 'as_dict') else self.__itemName
                        return d

                    def __repr__(self):
                        return "<Class _okButtonAction. kind: {}, buyParams: {}, itemName: {}>".format(limitedRepr(self.__kind[:20] if isinstance(self.__kind, bytes) else self.__kind), limitedRepr(self.__buyParams[:20] if isinstance(self.__buyParams, bytes) else self.__buyParams), limitedRepr(self.__itemName[:20] if isinstance(self.__itemName, bytes) else self.__itemName))
            ...
            _validations_map = {
                'kind': { 'required': True,},
                'm_allowed': { 'required': True,},
                'use_keychain': { 'required': True,},
                'isFree': { 'required': True,},
                'message': { 'required': True,},
                'explanation': { 'required': True,},
                'defaultButton': { 'required': True,},
                'okButtonString': { 'required': True,},
                'okButtonAction': { 'required': True,},
                'cancelButtonString': { 'required': True,},
                'initialCheckboxValue': { 'required': True,},
            }

            def __init__(self
                    , kind: str=None            , m_allowed: bool=None            , use_keychain: bool=None            , isFree: bool=None            , message: str=None            , explanation: str=None            , defaultButton: str=None            , okButtonString: str=None            , okButtonAction: _okButtonAction=None            , cancelButtonString: str=None            , initialCheckboxValue: bool=None            ):
                pass
                self.__kind = kind
            ...
            def _set_okButtonAction(self, value):
                if  not isinstance(value, StoreBuyproductResp._dialog._okButtonAction):
                    raise TypeError("okButtonAction must be StoreBuyproductResp._dialog._okButtonAction")
            ...
            initialCheckboxValue = property(_get_initialCheckboxValue, _set_initialCheckboxValue)
            ...
            def from_dict(d):
                ...
                if "kind" in d:
                    v["kind"] = str.from_dict(d["kind"]) if hasattr(str, 'from_dict') else d["kind"]
                if "m-allowed" in d:
                    v["m_allowed"] = bool.from_dict(d["m-allowed"]) if hasattr(bool, 'from_dict') else d["m-allowed"]
                if "use-keychain" in d:
                    v["use_keychain"] = bool.from_dict(d["use-keychain"]) if hasattr(bool, 'from_dict') else d["use-keychain"]
                if "isFree" in d:
                    v["isFree"] = bool.from_dict(d["isFree"]) if hasattr(bool, 'from_dict') else d["isFree"]
                if "message" in d:
                    v["message"] = str.from_dict(d["message"]) if hasattr(str, 'from_dict') else d["message"]
                if "explanation" in d:
                    v["explanation"] = str.from_dict(d["explanation"]) if hasattr(str, 'from_dict') else d["explanation"]
                if "defaultButton" in d:
                    v["defaultButton"] = str.from_dict(d["defaultButton"]) if hasattr(str, 'from_dict') else d["defaultButton"]
                if "okButtonString" in d:
                    v["okButtonString"] = str.from_dict(d["okButtonString"]) if hasattr(str, 'from_dict') else d["okButtonString"]
                if "okButtonAction" in d:
                    v["okButtonAction"] = StoreBuyproductResp._dialog._okButtonAction.from_dict(d["okButtonAction"]) if hasattr(StoreBuyproductResp._dialog._okButtonAction, 'from_dict') else d["okButtonAction"]
                if "cancelButtonString" in d:
                    v["cancelButtonString"] = str.from_dict(d["cancelButtonString"]) if hasattr(str, 'from_dict') else d["cancelButtonString"]
                if "initialCheckboxValue" in d:
                    v["initialCheckboxValue"] = bool.from_dict(d["initialCheckboxValue"]) if hasattr(bool, 'from_dict') else d["initialCheckboxValue"]
            ...
            def as_dict(self):
                ...
                if self.__m_allowed is not None:
                    d['m-allowed'] = self.__m_allowed.as_dict() if hasattr(self.__m_allowed, 'as_dict') else self.__m_allowed
                if self.__use_keychain is not None:
                    d['use-keychain'] = self.__use_keychain.as_dict() if hasattr(self.__use_keychain, 'as_dict') else self.__use_keychain
                if self.__isFree is not None:
                    d['isFree'] = self.__isFree.as_dict() if hasattr(self.__isFree, 'as_dict') else self.__isFree
                if self.__message is not None:
                    d['message'] = self.__message.as_dict() if hasattr(self.__message, 'as_dict') else self.__message
                if self.__explanation is not None:
                    d['explanation'] = self.__explanation.as_dict() if hasattr(self.__explanation, 'as_dict') else self.__explanation
                if self.__defaultButton is not None:
                    d['defaultButton'] = self.__defaultButton.as_dict() if hasattr(self.__defaultButton, 'as_dict') else self.__defaultButton
                if self.__okButtonString is not None:
                    d['okButtonString'] = self.__okButtonString.as_dict() if hasattr(self.__okButtonString, 'as_dict') else self.__okButtonString
                if self.__okButtonAction is not None:
                    d['okButtonAction'] = self.__okButtonAction.as_dict() if hasattr(self.__okButtonAction, 'as_dict') else self.__okButtonAction
                if self.__cancelButtonString is not None:
                    d['cancelButtonString'] = self.__cancelButtonString.as_dict() if hasattr(self.__cancelButtonString, 'as_dict') else self.__cancelButtonString
                if self.__initialCheckboxValue is not None:
                    d['initialCheckboxValue'] = self.__initialCheckboxValue.as_dict() if hasattr(self.__initialCheckboxValue, 'as_dict') else self.__initialCheckboxValue
                return d

            def __repr__(self):
                return "<Class _dialog. kind: {}, m_allowed: {}, use_keychain: {}, isFree: {}, message: {}, explanation: {}, defaultButton: {}, okButtonString: {}, okButtonAction: {}, cancelButtonString: {}, initialCheckboxValue: {}>".format(limitedRepr(self.__kind[:20] if isinstance(self.__kind, bytes) else self.__kind), limitedRepr(self.__m_allowed[:20] if isinstance(self.__m_allowed, bytes) else self.__m_allowed), limitedRepr(self.__use_keychain[:20] if isinstance(self.__use_keychain, bytes) else self.__use_keychain), limitedRepr(self.__isFree[:20] if isinstance(self.__isFree, bytes) else self.__isFree), limitedRepr(self.__message[:20] if isinstance(self.__message, bytes) else self.__message), limitedRepr(self.__explanation[:20] if isinstance(self.__explanation, bytes) else self.__explanation), limitedRepr(self.__defaultButton[:20] if isinstance(self.__defaultButton, bytes) else self.__defaultButton), limitedRepr(self.__okButtonString[:20] if isinstance(self.__okButtonString, bytes) else self.__okButtonString), limitedRepr(self.__okButtonAction[:20] if isinstance(self.__okButtonAction, bytes) else self.__okButtonAction), limitedRepr(self.__cancelButtonString[:20] if isinstance(self.__cancelButtonString, bytes) else self.__cancelButtonString), limitedRepr(self.__initialCheckboxValue[:20] if isinstance(self.__initialCheckboxValue, bytes) else self.__initialCheckboxValue))
    ...
    _validations_map = {
        'pings': { 'required': True,},
        'jingleDocType': { 'required': False,},
        'jingleAction': { 'required': False,},
        'status': { 'required': False,},
        'dsPersonId': { 'required': False,},
        'creditDisplay': { 'required': False,},
        'creditBalance': { 'required': False,},
        'freeSongBalance': { 'required': False,},
        'creditDisplayInternal': { 'required': False,},
        'authorized': { 'required': False,},
        'download_queue_item_count': { 'required': False,},
        'songList': { 'required': False,},
        'download_queue_info': { 'required': False,},
        'metrics': { 'required': True,},
        'duAnonymousPings': { 'required': False,},
        'subscriptionStatus': { 'required': False,},
        'cancel_purchase_batch': { 'required': False,},
        'failureType': { 'required': False,},
        'customerMessage': { 'required': False,},
        'm_allowed': { 'required': False,},
        'dialog': { 'required': False,},
    }

    def __init__(self
            , pings: List[float]
=None            , jingleDocType: str=None            , jingleAction: str=None            , status: int=None            , dsPersonId: str=None            , creditDisplay: str=None            , creditBalance: str=None            , freeSongBalance: str=None            , creditDisplayInternal: str=None            , authorized: bool=None            , download_queue_item_count: int=None            , songList: List[_songList]
=None            , download_queue_info: _download_queue_info=None            , metrics: _metrics=None            , duAnonymousPings: List[str]
=None            , subscriptionStatus: _subscriptionStatus=None            , cancel_purchase_batch: bool=None            , failureType: str=None            , customerMessage: str=None            , m_allowed: bool=None            , dialog: _dialog=None            ):
        pass
        self.__pings = pings
    ...
    creditDisplayInternal = property(_get_creditDisplayInternal, _set_creditDisplayInternal)
    ...
    def _set_songList(self, value):
        ...
        if value is not None and  not all(isinstance(i, StoreBuyproductResp._songList) for i in value):
            raise TypeError("songList list values must be StoreBuyproductResp._songList")
    ...
    def _set_download_queue_info(self, value):
        if value is not None and  not isinstance(value, StoreBuyproductResp._download_queue_info):
            raise TypeError("download_queue_info must be StoreBuyproductResp._download_queue_info")
    ...
    def _set_subscriptionStatus(self, value):
        if value is not None and  not isinstance(value, StoreBuyproductResp._subscriptionStatus):
    ...
    cancel_purchase_batch = property(_get_cancel_purchase_batch, _set_cancel_purchase_batch)
    ...
    def from_dict(d):
        v = {}
        if "pings" in d:
            v["pings"] = [float.from_dict(p) if hasattr(float, 'from_dict') else p for p in d["pings"]]
        if "jingleDocType" in d:
            v["jingleDocType"] = str.from_dict(d["jingleDocType"]) if hasattr(str, 'from_dict') else d["jingleDocType"]
        if "jingleAction" in d:
            v["jingleAction"] = str.from_dict(d["jingleAction"]) if hasattr(str, 'from_dict') else d["jingleAction"]
        if "status" in d:
            v["status"] = int.from_dict(d["status"]) if hasattr(int, 'from_dict') else d["status"]
        if "dsPersonId" in d:
            v["dsPersonId"] = str.from_dict(d["dsPersonId"]) if hasattr(str, 'from_dict') else d["dsPersonId"]
        ...
        if "creditBalance" in d:
            v["creditBalance"] = str.from_dict(d["creditBalance"]) if hasattr(str, 'from_dict') else d["creditBalance"]
        if "freeSongBalance" in d:
            v["freeSongBalance"] = str.from_dict(d["freeSongBalance"]) if hasattr(str, 'from_dict') else d["freeSongBalance"]
        if "creditDisplayInternal" in d:
            v["creditDisplayInternal"] = str.from_dict(d["creditDisplayInternal"]) if hasattr(str, 'from_dict') else d["creditDisplayInternal"]
        if "authorized" in d:
            v["authorized"] = bool.from_dict(d["authorized"]) if hasattr(bool, 'from_dict') else d["authorized"]
        if "download-queue-item-count" in d:
            v["download_queue_item_count"] = int.from_dict(d["download-queue-item-count"]) if hasattr(int, 'from_dict') else d["download-queue-item-count"]
        if "songList" in d:
            v["songList"] = [StoreBuyproductResp._songList.from_dict(p) if hasattr(StoreBuyproductResp._songList, 'from_dict') else p for p in d["songList"]]
        if "download-queue-info" in d:
            v["download_queue_info"] = StoreBuyproductResp._download_queue_info.from_dict(d["download-queue-info"]) if hasattr(StoreBuyproductResp._download_queue_info, 'from_dict') else d["download-queue-info"]
        if "metrics" in d:
            v["metrics"] = StoreBuyproductResp._metrics.from_dict(d["metrics"]) if hasattr(StoreBuyproductResp._metrics, 'from_dict') else d["metrics"]
        if "duAnonymousPings" in d:
            v["duAnonymousPings"] = [str.from_dict(p) if hasattr(str, 'from_dict') else p for p in d["duAnonymousPings"]]
        if "subscriptionStatus" in d:
            v["subscriptionStatus"] = StoreBuyproductResp._subscriptionStatus.from_dict(d["subscriptionStatus"]) if hasattr(StoreBuyproductResp._subscriptionStatus, 'from_dict') else d["subscriptionStatus"]
        if "cancel-purchase-batch" in d:
            v["cancel_purchase_batch"] = bool.from_dict(d["cancel-purchase-batch"]) if hasattr(bool, 'from_dict') else d["cancel-purchase-batch"]
        if "failureType" in d:
            v["failureType"] = str.from_dict(d["failureType"]) if hasattr(str, 'from_dict') else d["failureType"]
        if "customerMessage" in d:
            v["customerMessage"] = str.from_dict(d["customerMessage"]) if hasattr(str, 'from_dict') else d["customerMessage"]
        if "m-allowed" in d:
            v["m_allowed"] = bool.from_dict(d["m-allowed"]) if hasattr(bool, 'from_dict') else d["m-allowed"]
        if "dialog" in d:
            v["dialog"] = StoreBuyproductResp._dialog.from_dict(d["dialog"]) if hasattr(StoreBuyproductResp._dialog, 'from_dict') else d["dialog"]
    ...
    def as_dict(self):
        ...
        if self.__pings is not None:
            d['pings'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__pings]
        if self.__jingleDocType is not None:
            d['jingleDocType'] = self.__jingleDocType.as_dict() if hasattr(self.__jingleDocType, 'as_dict') else self.__jingleDocType
        if self.__jingleAction is not None:
            d['jingleAction'] = self.__jingleAction.as_dict() if hasattr(self.__jingleAction, 'as_dict') else self.__jingleAction
        if self.__status is not None:
            d['status'] = self.__status.as_dict() if hasattr(self.__status, 'as_dict') else self.__status
        if self.__dsPersonId is not None:
            d['dsPersonId'] = self.__dsPersonId.as_dict() if hasattr(self.__dsPersonId, 'as_dict') else self.__dsPersonId
