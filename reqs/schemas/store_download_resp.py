...
class StoreDownloadResp:
    class _songList:
            ...
            class _artwork_urls:
                    ...
                    def _set_default(self, value):
                        if  not isinstance(value, StoreDownloadResp._songList._artwork_urls._default):
                            raise TypeError("default must be StoreDownloadResp._songList._artwork_urls._default")
                    ...
                    def from_dict(d):
                        ...
                        if "default" in d:
                            v["default"] = StoreDownloadResp._songList._artwork_urls._default.from_dict(d["default"]) if hasattr(StoreDownloadResp._songList._artwork_urls._default, 'from_dict') else d["default"]
            ...
            class _metadata:
                    class _MacUIRequiredDeviceCapabilities:
                            ...
                            _validations_map = {
                                'arm64': { 'required': True,},
                                'gamekit': { 'required': True,},
                                'metal': { 'required': True,},
                            }

                            def __init__(self
                                    , arm64: bool=None            , gamekit: bool=None            , metal: bool=None            ):
                                pass
                                self.__arm64 = arm64
                            ...
                            def from_dict(d):
                                ...
                                if "gamekit" in d:
                                    v["gamekit"] = bool.from_dict(d["gamekit"]) if hasattr(bool, 'from_dict') else d["gamekit"]
                                if "metal" in d:
                                    v["metal"] = bool.from_dict(d["metal"]) if hasattr(bool, 'from_dict') else d["metal"]
                                return StoreDownloadResp._songList._metadata._MacUIRequiredDeviceCapabilities(**v)
                            ...
                            def as_dict(self):
                                ...
                                if self.__gamekit is not None:
                                    d['gamekit'] = self.__gamekit.as_dict() if hasattr(self.__gamekit, 'as_dict') else self.__gamekit
                                if self.__metal is not None:
                                    d['metal'] = self.__metal.as_dict() if hasattr(self.__metal, 'as_dict') else self.__metal
                                return d

                            def __repr__(self):
                                return "<Class _MacUIRequiredDeviceCapabilities. arm64: {}, gamekit: {}, metal: {}>".format(limitedRepr(self.__arm64[:20] if isinstance(self.__arm64, bytes) else self.__arm64), limitedRepr(self.__gamekit[:20] if isinstance(self.__gamekit, bytes) else self.__gamekit), limitedRepr(self.__metal[:20] if isinstance(self.__metal, bytes) else self.__metal))
                    ...
                    class _UIRequiredDeviceCapabilities:
                            ...
                            def from_dict(d):
                                ...
                                if "metal" in d:
                                    v["metal"] = bool.from_dict(d["metal"]) if hasattr(bool, 'from_dict') else d["metal"]
                                return StoreDownloadResp._songList._metadata._UIRequiredDeviceCapabilities(**v)
                            ...
                            def __repr__(self):
                                return "<Class _UIRequiredDeviceCapabilities. arm64: {}, gamekit: {}, metal: {}>".format(limitedRepr(self.__arm64[:20] if isinstance(self.__arm64, bytes) else self.__arm64), limitedRepr(self.__gamekit[:20] if isinstance(self.__gamekit, bytes) else self.__gamekit), limitedRepr(self.__metal[:20] if isinstance(self.__metal, bytes) else self.__metal))
                    ...
                    class _subgenres:
                            ...
                            def __init__(self
                                    , genre: str=None            , genreId: int=None            ):
                                pass
                                self.__genre = genre
                            ...
                            def __repr__(self):
                                return "<Class _subgenres. genre: {}, genreId: {}>".format(limitedRepr(self.__genre[:20] if isinstance(self.__genre, bytes) else self.__genre), limitedRepr(self.__genreId[:20] if isinstance(self.__genreId, bytes) else self.__genreId))
                ...
                =None            , subgenres: List[_subgenres]
                =None            , vendorId: int=None            , drmVersionNumber: int=None            , versionRestrictions: int=None            ):
                        pass
                    ...
                    def _set_MacUIRequiredDeviceCapabilities(self, value):
                        if  not isinstance(value, StoreDownloadResp._songList._metadata._MacUIRequiredDeviceCapabilities):
                            raise TypeError("MacUIRequiredDeviceCapabilities must be StoreDownloadResp._songList._metadata._MacUIRequiredDeviceCapabilities")
                    ...
                    def _set_UIRequiredDeviceCapabilities(self, value):
                        if  not isinstance(value, StoreDownloadResp._songList._metadata._UIRequiredDeviceCapabilities):
                            raise TypeError("UIRequiredDeviceCapabilities must be StoreDownloadResp._songList._metadata._UIRequiredDeviceCapabilities")
                    ...
                    def _set_rating(self, value):
                        if  not isinstance(value, StoreDownloadResp._songList._metadata._rating):
                            raise TypeError("rating must be StoreDownloadResp._songList._metadata._rating")
                    ...
                    def _set_subgenres(self, value):
                        ...
                        if  not all(isinstance(i, StoreDownloadResp._songList._metadata._subgenres) for i in value):
                            raise TypeError("subgenres list values must be StoreDownloadResp._songList._metadata._subgenres")
                    ...
                    def from_dict(d):
                        ...
                        if "MacUIRequiredDeviceCapabilities" in d:
                            v["MacUIRequiredDeviceCapabilities"] = StoreDownloadResp._songList._metadata._MacUIRequiredDeviceCapabilities.from_dict(d["MacUIRequiredDeviceCapabilities"]) if hasattr(StoreDownloadResp._songList._metadata._MacUIRequiredDeviceCapabilities, 'from_dict') else d["MacUIRequiredDeviceCapabilities"]
                        if "UIRequiredDeviceCapabilities" in d:
                            v["UIRequiredDeviceCapabilities"] = StoreDownloadResp._songList._metadata._UIRequiredDeviceCapabilities.from_dict(d["UIRequiredDeviceCapabilities"]) if hasattr(StoreDownloadResp._songList._metadata._UIRequiredDeviceCapabilities, 'from_dict') else d["UIRequiredDeviceCapabilities"]
                        if "artistId" in d:
                        ...
                        if "rating" in d:
                            v["rating"] = StoreDownloadResp._songList._metadata._rating.from_dict(d["rating"]) if hasattr(StoreDownloadResp._songList._metadata._rating, 'from_dict') else d["rating"]
                        if "releaseDate" in d:
                        ...
                        if "subgenres" in d:
                            v["subgenres"] = [StoreDownloadResp._songList._metadata._subgenres.from_dict(p) if hasattr(StoreDownloadResp._songList._metadata._subgenres, 'from_dict') else p for p in d["subgenres"]]
                        if "vendorId" in d:
                    ...
                    def as_dict(self):
                        ...
                        if self.__subgenres is not None:
                            d['subgenres'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__subgenres]
            ...
            def __init__(self
                    , songId: int=None            , URL: str=None            , downloadKey: str=None            , artworkURL: str=None            , artwork_urls: _artwork_urls=None            , md5: str=None            , chunks: _chunks=None            , isStreamable: bool=None            , uncompressedSize: str=None            , sinfs: List[_sinfs]
        =None            , purchaseDate: str=None            , download_id: str=None            , is_in_queue: bool=None            , asset_info: _asset_info=None            , metadata: _metadata=None            ):
            ...
            def _set_artwork_urls(self, value):
                if  not isinstance(value, StoreDownloadResp._songList._artwork_urls):
                    raise TypeError("artwork_urls must be StoreDownloadResp._songList._artwork_urls")
            ...
            def _set_sinfs(self, value):
                ...
                if  not all(isinstance(i, StoreDownloadResp._songList._sinfs) for i in value):
                    raise TypeError("sinfs list values must be StoreDownloadResp._songList._sinfs")
            ...
            def _set_asset_info(self, value):
                if  not isinstance(value, StoreDownloadResp._songList._asset_info):
                    raise TypeError("asset_info must be StoreDownloadResp._songList._asset_info")
            ...
            def _set_metadata(self, value):
                if  not isinstance(value, StoreDownloadResp._songList._metadata):
                    raise TypeError("metadata must be StoreDownloadResp._songList._metadata")
            ...
            def from_dict(d):
                ...
                if "artwork-urls" in d:
                    v["artwork_urls"] = StoreDownloadResp._songList._artwork_urls.from_dict(d["artwork-urls"]) if hasattr(StoreDownloadResp._songList._artwork_urls, 'from_dict') else d["artwork-urls"]
                if "md5" in d:
                    v["md5"] = str.from_dict(d["md5"]) if hasattr(str, 'from_dict') else d["md5"]
                if "chunks" in d:
                    v["chunks"] = StoreDownloadResp._songList._chunks.from_dict(d["chunks"]) if hasattr(StoreDownloadResp._songList._chunks, 'from_dict') else d["chunks"]
                ...
                if "uncompressedSize" in d:
                    v["uncompressedSize"] = str.from_dict(d["uncompressedSize"]) if hasattr(str, 'from_dict') else d["uncompressedSize"]
                if "sinfs" in d:
                    v["sinfs"] = [StoreDownloadResp._songList._sinfs.from_dict(p) if hasattr(StoreDownloadResp._songList._sinfs, 'from_dict') else p for p in d["sinfs"]]
                ...
                if "asset-info" in d:
                    v["asset_info"] = StoreDownloadResp._songList._asset_info.from_dict(d["asset-info"]) if hasattr(StoreDownloadResp._songList._asset_info, 'from_dict') else d["asset-info"]
                if "metadata" in d:
                    v["metadata"] = StoreDownloadResp._songList._metadata.from_dict(d["metadata"]) if hasattr(StoreDownloadResp._songList._metadata, 'from_dict') else d["metadata"]
    ...
    class _metrics:
            ...
            _validations_map = {
                'itemIds': { 'required': True,},
                'currency': { 'required': True,},
                'exchangeRateToUSD': { 'required': True,},
            }

            def __init__(self
                    , itemIds: List[int]
        =None            , currency: str=None            , exchangeRateToUSD: float=None            ):
                pass
            ...
            def __repr__(self):
                return "<Class _metrics. itemIds: {}, currency: {}, exchangeRateToUSD: {}>".format(limitedRepr(self.__itemIds[:20] if isinstance(self.__itemIds, bytes) else self.__itemIds), limitedRepr(self.__currency[:20] if isinstance(self.__currency, bytes) else self.__currency), limitedRepr(self.__exchangeRateToUSD[:20] if isinstance(self.__exchangeRateToUSD, bytes) else self.__exchangeRateToUSD))
    ...
    class _subscriptionStatus:
        ...
        =None            , account: _account=None            , family: _family=None            ):
            ...
            def _set_terms(self, value):
                ...
                if  not all(isinstance(i, StoreDownloadResp._subscriptionStatus._terms) for i in value):
                    raise TypeError("terms list values must be StoreDownloadResp._subscriptionStatus._terms")
            ...
            def _set_account(self, value):
                if  not isinstance(value, StoreDownloadResp._subscriptionStatus._account):
                    raise TypeError("account must be StoreDownloadResp._subscriptionStatus._account")
            ...
            def _set_family(self, value):
                if  not isinstance(value, StoreDownloadResp._subscriptionStatus._family):
                    raise TypeError("family must be StoreDownloadResp._subscriptionStatus._family")
            ...
            def from_dict(d):
                v = {}
                if "terms" in d:
                    v["terms"] = [StoreDownloadResp._subscriptionStatus._terms.from_dict(p) if hasattr(StoreDownloadResp._subscriptionStatus._terms, 'from_dict') else p for p in d["terms"]]
                if "account" in d:
                    v["account"] = StoreDownloadResp._subscriptionStatus._account.from_dict(d["account"]) if hasattr(StoreDownloadResp._subscriptionStatus._account, 'from_dict') else d["account"]
                if "family" in d:
                    v["family"] = StoreDownloadResp._subscriptionStatus._family.from_dict(d["family"]) if hasattr(StoreDownloadResp._subscriptionStatus._family, 'from_dict') else d["family"]
            ...
            def __repr__(self):
                return "<Class _subscriptionStatus. terms: {}, account: {}, family: {}>".format(limitedRepr(self.__terms[:20] if isinstance(self.__terms, bytes) else self.__terms), limitedRepr(self.__account[:20] if isinstance(self.__account, bytes) else self.__account), limitedRepr(self.__family[:20] if isinstance(self.__family, bytes) else self.__family))
    ...
    _validations_map = {
        ...
        'jingleDocType': { 'required': True,},
        'jingleAction': { 'required': True,},
        'status': { 'required': True,},
        'dsPersonId': { 'required': True,},
        'creditDisplay': { 'required': True,},
        'creditBalance': { 'required': True,},
        'freeSongBalance': { 'required': True,},
        'authorized': { 'required': True,},
        'download_queue_item_count': { 'required': True,},
        'songList': { 'required': True,},
        'metrics': { 'required': True,},
        'subscriptionStatus': { 'required': True,},
    }

    def __init__(self
            , pings: List[float]
=None            , cancel_purchase_batch: bool=None            , customerMessage: str=None            , failureType: str=None            , jingleDocType: str=None            , jingleAction: str=None            , status: int=None            , dsPersonId: str=None            , creditDisplay: str=None            , creditBalance: str=None            , freeSongBalance: str=None            , authorized: bool=None            , download_queue_item_count: int=None            , songList: List[_songList]
=None            , metrics: _metrics=None            , subscriptionStatus: _subscriptionStatus=None            ):
        pass
        self.__pings = pings
    ...
    def _set_subscriptionStatus(self, value):
        if  not isinstance(value, StoreDownloadResp._subscriptionStatus):
            raise TypeError("subscriptionStatus must be StoreDownloadResp._subscriptionStatus")
    ...
    def from_dict(d):
        ...
        if "songList" in d:
            v["songList"] = [StoreDownloadResp._songList.from_dict(p) if hasattr(StoreDownloadResp._songList, 'from_dict') else p for p in d["songList"]]
        if "metrics" in d:
            v["metrics"] = StoreDownloadResp._metrics.from_dict(d["metrics"]) if hasattr(StoreDownloadResp._metrics, 'from_dict') else d["metrics"]
        if "subscriptionStatus" in d:
            v["subscriptionStatus"] = StoreDownloadResp._subscriptionStatus.from_dict(d["subscriptionStatus"]) if hasattr(StoreDownloadResp._subscriptionStatus, 'from_dict') else d["subscriptionStatus"]
    ...
    def __repr__(self):
        return "<Class StoreDownloadResp. pings: {}, cancel_purchase_batch: {}, customerMessage: {}, failureType: {}, jingleDocType: {}, jingleAction: {}, status: {}, dsPersonId: {}, creditDisplay: {}, creditBalance: {}, freeSongBalance: {}, authorized: {}, download_queue_item_count: {}, songList: {}, metrics: {}, subscriptionStatus: {}>".format(limitedRepr(self.__pings[:20] if isinstance(self.__pings, bytes) else self.__pings), limitedRepr(self.__cancel_purchase_batch[:20] if isinstance(self.__cancel_purchase_batch, bytes) else self.__cancel_purchase_batch), limitedRepr(self.__customerMessage[:20] if isinstance(self.__customerMessage, bytes) else self.__customerMessage), limitedRepr(self.__failureType[:20] if isinstance(self.__failureType, bytes) else self.__failureType), limitedRepr(self.__jingleDocType[:20] if isinstance(self.__jingleDocType, bytes) else self.__jingleDocType), limitedRepr(self.__jingleAction[:20] if isinstance(self.__jingleAction, bytes) else self.__jingleAction), limitedRepr(self.__status[:20] if isinstance(self.__status, bytes) else self.__status), limitedRepr(self.__dsPersonId[:20] if isinstance(self.__dsPersonId, bytes) else self.__dsPersonId), limitedRepr(self.__creditDisplay[:20] if isinstance(self.__creditDisplay, bytes) else self.__creditDisplay), limitedRepr(self.__creditBalance[:20] if isinstance(self.__creditBalance, bytes) else self.__creditBalance), limitedRepr(self.__freeSongBalance[:20] if isinstance(self.__freeSongBalance, bytes) else self.__freeSongBalance), limitedRepr(self.__authorized[:20] if isinstance(self.__authorized, bytes) else self.__authorized), limitedRepr(self.__download_queue_item_count[:20] if isinstance(self.__download_queue_item_count, bytes) else self.__download_queue_item_count), limitedRepr(self.__songList[:20] if isinstance(self.__songList, bytes) else self.__songList), limitedRepr(self.__metrics[:20] if isinstance(self.__metrics, bytes) else self.__metrics), limitedRepr(self.__subscriptionStatus[:20] if isinstance(self.__subscriptionStatus, bytes) else self.__subscriptionStatus))
